 ...
 * $RCSfile$
 * $Revision: 3492 $
 * $Date: 2006-02-27 15:17:27 -0300 (Mon, 27 Feb 2006) $
 *
...
class PacketReader {
    ...
    void notifyConnectionError(Exception e) {
        ...
        //by Eduardo Martins e.printStackTrace();
                        ...
                        if ("jabber:client".equals(parser.getNamespace(null))) {
                            ...
                            for (int i=0; i<parser.getAttributeCount(); i++) {
                                if (parser.getAttributeName(i).equals("id")) {
                                	...
                                	if (connection.serviceName == null) connection.serviceName = parser.getAttributeValue(i);
                                }
                            }                            
                        }
                        
                        // Eduardo Martins: handshake processing
                        else if ("jabber:component:accept".equals(parser.getNamespace(null))) {                        	
                        	// Save the connectionID
                        	...
                        	synchronized(this) {                        		                        		
                        		...
                        		connection.writer.write("<handshake>" + StringUtils.hash(connectionID+ ((ComponentXMPPConnection) connection).componentSecret) + "</handshake>");                                   
                        		connection.writer.flush();
                        	}
                        }                			
                		else {
                			throw new XMPPException("Unexpected stream namespace!");                			
                		}
                    }
