    ...
    private void initReaderAndWriter() throws XMPPException {
        try {
            if (!usingCompression) {
            	...
            	//reader = new BufferedReader(new DebugInputStreamReader(socket.getInputStream(), "UTF-8"));
                //writer = new BufferedWriter(new DebugOutputStreamWriter(socket.getOutputStream(), "UTF-8"));
            }
            else {
                try {
