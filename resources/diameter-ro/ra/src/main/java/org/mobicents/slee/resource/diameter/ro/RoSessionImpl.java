...
/**
 * Implementation of {@link RoSession}.
 * 
...
public abstract class RoSessionImpl extends CreditControlSessionImpl implements RoSession {
   ...
   * @param endpoint
   */
  public RoSessionImpl(RoMessageFactory messageFactory, RoAvpFactory avpFactory, Session session, EventListener<Request, Answer> raEventListener, DiameterIdentity destinationHost, DiameterIdentity destinationRealm, SleeEndpoint endpoint) {
