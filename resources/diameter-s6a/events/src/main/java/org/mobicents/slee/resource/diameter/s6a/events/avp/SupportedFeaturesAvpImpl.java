...
/**
 * Implementation for {@link SupportedFeaturesAvp}
 * 
...
public class SupportedFeaturesAvpImpl extends GroupedAvpImpl implements SupportedFeaturesAvp {
  ...
  public long getFeatureList() {
    return getAvpAsUnsigned32(DiameterS6aAvpCodes.FEATURE_LIST, DiameterS6aAvpCodes.S6A_VENDOR_ID);
  }
  ...
  public boolean hasFeatureList() {
    return hasAvp(DiameterS6aAvpCodes.FEATURE_LIST, DiameterS6aAvpCodes.S6A_VENDOR_ID);
  }
  ...
  public void setFeatureList(long featureList) {
    addAvp(DiameterS6aAvpCodes.FEATURE_LIST, DiameterS6aAvpCodes.S6A_VENDOR_ID, featureList);
  }
  ...
  public long getFeatureListId() {
    return getAvpAsUnsigned32(DiameterS6aAvpCodes.FEATURE_LIST_ID, DiameterS6aAvpCodes.S6A_VENDOR_ID);
  }
  ...
  public boolean hasFeatureListId() {
    return hasAvp(DiameterS6aAvpCodes.FEATURE_LIST_ID, DiameterS6aAvpCodes.S6A_VENDOR_ID);
  }
  ...
  public void setFeatureListId(long featureListId) {
    addAvp(DiameterS6aAvpCodes.FEATURE_LIST_ID, DiameterS6aAvpCodes.S6A_VENDOR_ID, featureListId);
  }
