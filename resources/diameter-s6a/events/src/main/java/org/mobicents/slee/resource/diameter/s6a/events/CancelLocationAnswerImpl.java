...
/**
 * Implementation for {@link CancelLocationAnswer}
 * 
...
public class CancelLocationAnswerImpl extends DiameterMessageImpl implements CancelLocationAnswer {
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.CancelLocationAnswer#hasAuthSessionState()
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.CancelLocationAnswer#getAuthSessionState()
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.CancelLocationAnswer#setAuthSessionState(net.java.slee.resource.diameter.base.events.avp.AuthSessionStateType)
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.CancelLocationAnswer#setSupportedFeatures(net.java.slee.resource.diameter.s6a.events.avp.SupportedFeaturesAvp)
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.CancelLocationAnswer#setSupportedFeatureses(net.java.slee.resource.diameter.s6a.events.avp.SupportedFeaturesAvp[])
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.CancelLocationAnswer#getSupportedFeatureses()
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.CancelLocationAnswer#hasExperimentalResult()
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.CancelLocationAnswer#getExperimentalResult()
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.CancelLocationAnswer#setExperimentalResult(net.java.slee.resource.diameter.base.events.avp.ExperimentalResultAvp)
   */
