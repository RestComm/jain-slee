...
/**
 * Implementation for {@link SGSNUserStateAvp}
 * 
 * @author <a href="mailto:brainslog@gmail.com"> Alexandre Mendonca </a>
 */
public class SGSNUserStateAvpImpl extends GroupedAvpImpl implements SGSNUserStateAvp {

  public SGSNUserStateAvpImpl() {
    super();
  }

  public SGSNUserStateAvpImpl(int code, long vendorId, int mnd, int prt, byte[] value) {
