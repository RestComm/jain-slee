...
/**
 * Implementation for {@link ResetAnswer}
 * 
 * @author <a href="mailto:brainslog@gmail.com"> Alexandre Mendonca </a>
 */
public class ResetAnswerImpl extends DiameterMessageImpl implements ResetAnswer {

  /**
   * @param message
   */
  public ResetAnswerImpl(Message message) {
    super(message);
  }
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.ResetAnswer#hasAuthSessionState()
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.ResetAnswer#getAuthSessionState()
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.ResetAnswer#setAuthSessionState(net.java.slee.resource.diameter.base.events.avp.AuthSessionStateType)
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.ResetAnswer#setSupportedFeatures(net.java.slee.resource.diameter.s6a.events.avp.SupportedFeaturesAvp)
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.ResetAnswer#setSupportedFeatureses(net.java.slee.resource.diameter.s6a.events.avp.SupportedFeaturesAvp[])
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.ResetAnswer#getSupportedFeatureses()
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.ResetAnswer#hasExperimentalResult()
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.ResetAnswer#getExperimentalResult()
   */
  ...
  /* (non-Javadoc)
   * @see net.java.slee.resource.diameter.s6a.events.ResetAnswer#setExperimentalResult(net.java.slee.resource.diameter.base.events.avp.ExperimentalResultAvp)
   */
