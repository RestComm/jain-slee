...
public class EventIDCache {
  ...
  static {
    ...
    eventsTemp.put(SubscribeNotificationsRequest.commandCode, SH_PACKAGE_PREFIX + "SubscribeNotifications");
    eventsTemp.put(UserDataRequest.commandCode, SH_PACKAGE_PREFIX + "UserData");
