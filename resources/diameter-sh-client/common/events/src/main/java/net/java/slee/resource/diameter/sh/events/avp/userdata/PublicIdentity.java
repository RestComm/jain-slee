...
/**
 * <p>Interface for tPublicIdentity complex type.
 * 
...
public interface PublicIdentity {
  ...
  /**
   * Gets the value of the imsPublicIdentity property.
   * 
   * <p>
   * This accessor method returns a reference to the live list,
   * not a snapshot. Therefore any modification you make to the
   * returned list will be present inside the JAXB object.
   * This is why there is not a <CODE>set</CODE> method for the imsPublicIdentity property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * <pre>
   *    getIMSPublicIdentity().add(newItem);
   * </pre>
   * 
   * 
   * <p>
   ...
   * 
   */
  public abstract List<String> getIMSPublicIdentity();
   ...
   * 
   */
  public abstract List<String> getMSISDN();
   ...
   *     
   */
  public abstract PublicIdentityExtension getExtension();
   ...
   *     
   */
  public abstract void setExtension(PublicIdentityExtension value);
