...
/**
 * <p>Interface for tSePoTriExtension complex type.
 * 
...
public interface SePoTriExtension {
   ...
   * This is why there is not a <CODE>set</CODE> method for the registrationType property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * <pre>
   *    getRegistrationType().add(newItem);
   * </pre>
   * 
   * 
   * <p>
   ...
   * 
   */
  public abstract List<Short> getRegistrationType();
