...
public class _IpQoSMenuStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.csapi.cm.IpQoSMenu
{
	...
	public final static java.lang.Class _opsClass = org.csapi.cm.IpQoSMenuOperations.class;
	public void setCallbackWithSessionID(org.csapi.IpInterface appInterface, int sessionID) throws org.csapi.P_INVALID_INTERFACE_TYPE,org.csapi.TpCommonExceptions,org.csapi.P_INVALID_SESSION_ID
	{
		...
		else
		{
			...
			IpQoSMenuOperations _localServant = (IpQoSMenuOperations)_so.servant;
			try
			{
	...
	public java.lang.String[] getTemplateList() throws org.csapi.TpCommonExceptions,org.csapi.cm.P_UNKNOWN_TEMPLATES
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getTemplateList", true);
				_is = _invoke(_os);
			...
			catch( org.omg.CORBA.portable.ApplicationException _ax )
			{
				...
				else if( _id.equals("IDL:org/csapi/cm/P_UNKNOWN_TEMPLATES:1.0"))
				{
					throw org.csapi.cm.P_UNKNOWN_TEMPLATESHelper.read(_ax.getInputStream());
				}
				else 
					throw new RuntimeException("Unexpected exception " + _id );
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getTemplateList", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpQoSMenuOperations _localServant = (IpQoSMenuOperations)_so.servant;
			java.lang.String[] _result;			try
			{
			_result = _localServant.getTemplateList();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public org.csapi.IpInterface getTemplate(java.lang.String templateType) throws org.csapi.TpCommonExceptions
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getTemplate", true);
				_os.write_string(templateType);
				_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getTemplate", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpQoSMenuOperations _localServant = (IpQoSMenuOperations)_so.servant;
			org.csapi.IpInterface _result;			try
			{
			_result = _localServant.getTemplate(templateType);
			}
			finally
			{
				_servant_postinvoke(_so);
