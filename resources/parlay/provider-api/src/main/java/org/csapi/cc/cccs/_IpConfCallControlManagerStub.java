...
public class _IpConfCallControlManagerStub
	...
	implements org.csapi.cc.cccs.IpConfCallControlManager
{
	...
	public final static java.lang.Class _opsClass = org.csapi.cc.cccs.IpConfCallControlManagerOperations.class;
	public void disableNotifications() throws org.csapi.TpCommonExceptions
	{
		...
		else
		{
			...
			IpConfCallControlManagerOperations _localServant = (IpConfCallControlManagerOperations)_so.servant;
			try
			{
	...
	public org.csapi.cc.cccs.TpResourceReservation reserveResources(org.csapi.cc.cccs.IpAppConfCallControlManager appInterface, java.lang.String startTime, int numberOfParticipants, int duration, org.csapi.cc.cccs.TpConfPolicy conferencePolicy) throws org.csapi.TpCommonExceptions
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "reserveResources", true);
				org.csapi.cc.cccs.IpAppConfCallControlManagerHelper.write(_os,appInterface);
				_os.write_string(startTime);
				_os.write_long(numberOfParticipants);
				_os.write_long(duration);
				org.csapi.cc.cccs.TpConfPolicyHelper.write(_os,conferencePolicy);
				_is = _invoke(_os);
				org.csapi.cc.cccs.TpResourceReservation _result = org.csapi.cc.cccs.TpResourceReservationHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "reserveResources", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallControlManagerOperations _localServant = (IpConfCallControlManagerOperations)_so.servant;
			org.csapi.cc.cccs.TpResourceReservation _result;			try
			{
			_result = _localServant.reserveResources(appInterface,startTime,numberOfParticipants,duration,conferencePolicy);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public int createMediaNotification(org.csapi.cc.mmccs.IpAppMultiMediaCallControlManager appInterface, org.csapi.cc.mmccs.TpNotificationMediaRequest notificationMediaRequest) throws org.csapi.P_INVALID_INTERFACE_TYPE,org.csapi.P_INVALID_EVENT_TYPE,org.csapi.TpCommonExceptions,org.csapi.P_INVALID_CRITERIA
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "createMediaNotification", true);
				org.csapi.cc.mmccs.IpAppMultiMediaCallControlManagerHelper.write(_os,appInterface);
				org.csapi.cc.mmccs.TpNotificationMediaRequestHelper.write(_os,notificationMediaRequest);
				_is = _invoke(_os);
				int _result = _is.read_long();
				return _result;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "createMediaNotification", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallControlManagerOperations _localServant = (IpConfCallControlManagerOperations)_so.servant;
			int _result;			try
			{
			_result = _localServant.createMediaNotification(appInterface,notificationMediaRequest);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void destroyMediaNotification(int assignmentID) throws org.csapi.TpCommonExceptions
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "destroyMediaNotification", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "destroyMediaNotification", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallControlManagerOperations _localServant = (IpConfCallControlManagerOperations)_so.servant;
			try
			{
			_localServant.destroyMediaNotification(assignmentID);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public org.csapi.cc.cccs.TpConfCallIdentifier createConference(org.csapi.cc.cccs.IpAppConfCall appConferenceCall, int numberOfSubConferences, org.csapi.cc.cccs.TpConfPolicy conferencePolicy, int numberOfParticipants, int duration) throws org.csapi.TpCommonExceptions
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "createConference", true);
				org.csapi.cc.cccs.IpAppConfCallHelper.write(_os,appConferenceCall);
				_os.write_long(numberOfSubConferences);
				org.csapi.cc.cccs.TpConfPolicyHelper.write(_os,conferencePolicy);
				_os.write_long(numberOfParticipants);
				_os.write_long(duration);
				_is = _invoke(_os);
				org.csapi.cc.cccs.TpConfCallIdentifier _result = org.csapi.cc.cccs.TpConfCallIdentifierHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "createConference", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallControlManagerOperations _localServant = (IpConfCallControlManagerOperations)_so.servant;
			org.csapi.cc.cccs.TpConfCallIdentifier _result;			try
			{
			_result = _localServant.createConference(appConferenceCall,numberOfSubConferences,conferencePolicy,numberOfParticipants,duration);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public org.csapi.cc.cccs.TpConfSearchResult checkResources(org.csapi.cc.cccs.TpConfSearchCriteria searchCriteria) throws org.csapi.TpCommonExceptions
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "checkResources", true);
				org.csapi.cc.cccs.TpConfSearchCriteriaHelper.write(_os,searchCriteria);
				_is = _invoke(_os);
				org.csapi.cc.cccs.TpConfSearchResult _result = org.csapi.cc.cccs.TpConfSearchResultHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "checkResources", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallControlManagerOperations _localServant = (IpConfCallControlManagerOperations)_so.servant;
			org.csapi.cc.cccs.TpConfSearchResult _result;			try
			{
			_result = _localServant.checkResources(searchCriteria);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void freeResources(org.csapi.cc.cccs.TpResourceReservation resourceReservation) throws org.csapi.TpCommonExceptions
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "freeResources", true);
				org.csapi.cc.cccs.TpResourceReservationHelper.write(_os,resourceReservation);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "freeResources", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallControlManagerOperations _localServant = (IpConfCallControlManagerOperations)_so.servant;
			try
			{
			_localServant.freeResources(resourceReservation);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public org.csapi.cc.mmccs.TpMediaNotificationRequested[] getMediaNotification() throws org.csapi.TpCommonExceptions
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getMediaNotification", true);
				_is = _invoke(_os);
				org.csapi.cc.mmccs.TpMediaNotificationRequested[] _result = org.csapi.cc.mmccs.TpMediaNotificationRequestedSetHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getMediaNotification", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallControlManagerOperations _localServant = (IpConfCallControlManagerOperations)_so.servant;
			org.csapi.cc.mmccs.TpMediaNotificationRequested[] _result;			try
			{
			_result = _localServant.getMediaNotification();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void changeMediaNotification(int assignmentID, org.csapi.cc.mmccs.TpNotificationMediaRequest notificationMediaRequest) throws org.csapi.P_INVALID_ASSIGNMENT_ID,org.csapi.P_INVALID_EVENT_TYPE,org.csapi.TpCommonExceptions,org.csapi.P_INVALID_CRITERIA
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "changeMediaNotification", true);
				_os.write_long(assignmentID);
				org.csapi.cc.mmccs.TpNotificationMediaRequestHelper.write(_os,notificationMediaRequest);
				_is = _invoke(_os);
				return;
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "changeMediaNotification", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallControlManagerOperations _localServant = (IpConfCallControlManagerOperations)_so.servant;
			try
			{
			_localServant.changeMediaNotification(assignmentID,notificationMediaRequest);
			}
			finally
			{
				_servant_postinvoke(_so);
