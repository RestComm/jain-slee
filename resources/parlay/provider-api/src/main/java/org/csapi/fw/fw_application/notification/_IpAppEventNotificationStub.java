...
public class _IpAppEventNotificationStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.csapi.fw.fw_application.notification.IpAppEventNotification
{
	...
	public final static java.lang.Class _opsClass = org.csapi.fw.fw_application.notification.IpAppEventNotificationOperations.class;
	public void reportNotification(org.csapi.fw.TpFwEventInfo eventInfo, int assignmentID)
	{
		...
		else
		{
			...
			IpAppEventNotificationOperations _localServant = (IpAppEventNotificationOperations)_so.servant;
			try
			{
