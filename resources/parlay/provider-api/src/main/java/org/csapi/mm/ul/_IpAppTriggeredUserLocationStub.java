...
public class _IpAppTriggeredUserLocationStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.csapi.mm.ul.IpAppTriggeredUserLocation
{
	...
	public final static java.lang.Class _opsClass = org.csapi.mm.ul.IpAppTriggeredUserLocationOperations.class;
	public void locationReportRes(int assignmentId, org.csapi.mm.TpUserLocation[] locations)
	{
		...
		else
		{
			...
			IpAppTriggeredUserLocationOperations _localServant = (IpAppTriggeredUserLocationOperations)_so.servant;
			try
			{
	...
	public void triggeredLocationReport(int assignmentId, org.csapi.mm.TpUserLocationExtended location, org.csapi.mm.TpLocationTriggerCriteria criterion)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_os.write_long(assignmentId);
				org.csapi.mm.TpUserLocationExtendedHelper.write(_os,location);
				org.csapi.mm.TpLocationTriggerCriteriaHelper.write(_os,criterion);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
