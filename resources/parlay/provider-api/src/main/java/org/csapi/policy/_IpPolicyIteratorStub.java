...
public class _IpPolicyIteratorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.csapi.policy.IpPolicyIterator
{
	private String[] ids = {"IDL:org/csapi/policy/IpPolicyIterator:1.0","IDL:org/csapi/IpInterface:1.0","IDL:org/csapi/policy/IpPolicy:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.csapi.policy.IpPolicyIteratorOperations.class;
	public void setAttributes(org.csapi.TpAttribute[] targetAttributes) throws org.csapi.TpCommonExceptions,org.csapi.policy.P_ACCESS_VIOLATION,org.csapi.policy.P_NO_TRANSACTION_IN_PROCESS
	{
		...
		else
		{
			...
			IpPolicyIteratorOperations _localServant = (IpPolicyIteratorOperations)_so.servant;
			try
			{
	...
	public java.lang.String[] getList(int startIndex, int numberRequested) throws org.csapi.TpCommonExceptions
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getList", true);
				_os.write_long(startIndex);
				_os.write_long(numberRequested);
				_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getList", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpPolicyIteratorOperations _localServant = (IpPolicyIteratorOperations)_so.servant;
			java.lang.String[] _result;			try
			{
			_result = _localServant.getList(startIndex,numberRequested);
			}
			finally
			{
				_servant_postinvoke(_so);
