...
public class _IpConfCallStub
	...
	implements org.csapi.cc.cccs.IpConfCall
{
	...
	public final static java.lang.Class _opsClass = org.csapi.cc.cccs.IpConfCallOperations.class;
	public void setCallback(org.csapi.IpInterface appInterface) throws org.csapi.P_INVALID_INTERFACE_TYPE,org.csapi.TpCommonExceptions
	{
		...
		else
		{
			...
			IpConfCallOperations _localServant = (IpConfCallOperations)_so.servant;
			try
			{
	...
	public org.csapi.cc.cccs.TpSubConfCallIdentifier[] getSubConferences(int conferenceSessionID) throws org.csapi.TpCommonExceptions,org.csapi.P_INVALID_SESSION_ID
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getSubConferences", true);
				_os.write_long(conferenceSessionID);
				_is = _invoke(_os);
				org.csapi.cc.cccs.TpSubConfCallIdentifier[] _result = org.csapi.cc.cccs.TpSubConfCallIdentifierSetHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getSubConferences", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallOperations _localServant = (IpConfCallOperations)_so.servant;
			org.csapi.cc.cccs.TpSubConfCallIdentifier[] _result;			try
			{
			_result = _localServant.getSubConferences(conferenceSessionID);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public org.csapi.cc.cccs.TpSubConfCallIdentifier createSubConference(int conferenceSessionID, org.csapi.cc.cccs.IpAppSubConfCall appSubConference, org.csapi.cc.cccs.TpConfPolicy conferencePolicy) throws org.csapi.TpCommonExceptions,org.csapi.P_INVALID_SESSION_ID
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "createSubConference", true);
				_os.write_long(conferenceSessionID);
				org.csapi.cc.cccs.IpAppSubConfCallHelper.write(_os,appSubConference);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "createSubConference", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallOperations _localServant = (IpConfCallOperations)_so.servant;
			org.csapi.cc.cccs.TpSubConfCallIdentifier _result;			try
			{
			_result = _localServant.createSubConference(conferenceSessionID,appSubConference,conferencePolicy);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public org.csapi.TpAddress getConferenceAddress(int conferenceSessionID) throws org.csapi.TpCommonExceptions,org.csapi.P_INVALID_SESSION_ID
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getConferenceAddress", true);
				_os.write_long(conferenceSessionID);
				_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getConferenceAddress", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallOperations _localServant = (IpConfCallOperations)_so.servant;
			org.csapi.TpAddress _result;			try
			{
			_result = _localServant.getConferenceAddress(conferenceSessionID);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void leaveMonitorReq(int conferenceSessionID) throws org.csapi.TpCommonExceptions,org.csapi.P_INVALID_SESSION_ID
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "leaveMonitorReq", true);
				_os.write_long(conferenceSessionID);
				_is = _invoke(_os);
				return;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "leaveMonitorReq", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpConfCallOperations _localServant = (IpConfCallOperations)_so.servant;
			try
			{
			_localServant.leaveMonitorReq(conferenceSessionID);
			}
			finally
			{
				_servant_postinvoke(_so);
