...
/**
 *	Generated from IDL definition of alias "TpUnsignedInt16"
 *	@author JacORB IDL compiler 
 */

public final class TpUnsignedInt16Helper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.csapi.TpUnsignedInt16Helper.id(), "TpUnsignedInt16",org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(4)));
		}
		return _type;
	}
	...
	{
		return "IDL:org/csapi/TpUnsignedInt16:1.0";
	}
