...
{
	private IpMultiPartyCallControlManagerOperations _delegate;
	...
	public IpMultiPartyCallControlManagerPOATie(IpMultiPartyCallControlManagerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
