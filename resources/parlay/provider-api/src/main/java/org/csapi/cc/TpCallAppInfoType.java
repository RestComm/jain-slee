	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public static final int _P_CALL_APP_ORIGINAL_DESTINATION_ADDRESS = 9;
	public static final TpCallAppInfoType P_CALL_APP_ORIGINAL_DESTINATION_ADDRESS = new TpCallAppInfoType(_P_CALL_APP_ORIGINAL_DESTINATION_ADDRESS);
	public static final int _P_CALL_APP_REDIRECTING_ADDRESS = 10;
	public static final TpCallAppInfoType P_CALL_APP_REDIRECTING_ADDRESS = new TpCallAppInfoType(_P_CALL_APP_REDIRECTING_ADDRESS);
	public static final int _P_CALL_APP_HIGH_PROBABILITY_COMPLETION = 11;
	public static final TpCallAppInfoType P_CALL_APP_HIGH_PROBABILITY_COMPLETION = new TpCallAppInfoType(_P_CALL_APP_HIGH_PROBABILITY_COMPLETION);
	public static final int _P_CALL_APP_CARRIER = 12;
	public static final TpCallAppInfoType P_CALL_APP_CARRIER = new TpCallAppInfoType(_P_CALL_APP_CARRIER);
	public int value()
	{
		return value;
	}
	public static TpCallAppInfoType from_int(int value)
	{
		switch (value) {
			...
			case _P_CALL_APP_ORIGINAL_DESTINATION_ADDRESS: return P_CALL_APP_ORIGINAL_DESTINATION_ADDRESS;
			case _P_CALL_APP_REDIRECTING_ADDRESS: return P_CALL_APP_REDIRECTING_ADDRESS;
			case _P_CALL_APP_HIGH_PROBABILITY_COMPLETION: return P_CALL_APP_HIGH_PROBABILITY_COMPLETION;
			case _P_CALL_APP_CARRIER: return P_CALL_APP_CARRIER;
