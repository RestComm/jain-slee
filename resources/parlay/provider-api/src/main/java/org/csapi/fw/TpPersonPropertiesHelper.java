...
/**
 *	Generated from IDL definition of alias "TpPersonProperties"
 *	@author JacORB IDL compiler 
 */

public final class TpPersonPropertiesHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.csapi.fw.TpPersonPropertiesHelper.id(), "TpPersonProperties",org.csapi.fw.TpPropertyListHelper.type());
		}
		return _type;
	}
	...
	{
		return "IDL:org/csapi/fw/TpPersonProperties:1.0";
	}
