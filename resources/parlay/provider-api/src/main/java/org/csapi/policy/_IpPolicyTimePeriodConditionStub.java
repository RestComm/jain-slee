...
public class _IpPolicyTimePeriodConditionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.csapi.policy.IpPolicyTimePeriodCondition
{
	private String[] ids = {"IDL:org/csapi/policy/IpPolicyTimePeriodCondition:1.0","IDL:org/csapi/policy/IpPolicyCondition:1.0","IDL:org/csapi/policy/IpPolicy:1.0","IDL:org/csapi/IpInterface:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.csapi.policy.IpPolicyTimePeriodConditionOperations.class;
	public org.csapi.policy.IpPolicyRepository getParentRepository() throws org.csapi.TpCommonExceptions
	{
		...
		else
		{
			...
			IpPolicyTimePeriodConditionOperations _localServant = (IpPolicyTimePeriodConditionOperations)_so.servant;
