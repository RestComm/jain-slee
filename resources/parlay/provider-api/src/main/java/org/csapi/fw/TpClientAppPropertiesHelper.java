...
/**
 *	Generated from IDL definition of alias "TpClientAppProperties"
 *	@author JacORB IDL compiler 
 */

public final class TpClientAppPropertiesHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.csapi.fw.TpClientAppPropertiesHelper.id(), "TpClientAppProperties",org.csapi.fw.TpPropertyListHelper.type());
		}
		return _type;
	}
	...
	{
		return "IDL:org/csapi/fw/TpClientAppProperties:1.0";
	}
