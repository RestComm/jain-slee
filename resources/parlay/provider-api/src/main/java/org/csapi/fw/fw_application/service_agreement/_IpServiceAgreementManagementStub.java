...
public class _IpServiceAgreementManagementStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.csapi.fw.fw_application.service_agreement.IpServiceAgreementManagement
{
	...
	public final static java.lang.Class _opsClass = org.csapi.fw.fw_application.service_agreement.IpServiceAgreementManagementOperations.class;
	public org.csapi.fw.TpSignatureAndServiceMgr signServiceAgreement(java.lang.String serviceToken, java.lang.String agreementText, java.lang.String signingAlgorithm) throws org.csapi.fw.P_INVALID_SIGNING_ALGORITHM,org.csapi.TpCommonExceptions,org.csapi.fw.P_INVALID_AGREEMENT_TEXT,org.csapi.fw.P_ACCESS_DENIED,org.csapi.fw.P_INVALID_SERVICE_TOKEN,org.csapi.fw.P_SERVICE_ACCESS_DENIED
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				org.csapi.fw.TpSignatureAndServiceMgr _result = org.csapi.fw.TpSignatureAndServiceMgrHelper.read(_is);
				return _result;
			}
			...
			catch( org.omg.CORBA.portable.ApplicationException _ax )
			{
				...
				else if( _id.equals("IDL:org/csapi/fw/P_SERVICE_ACCESS_DENIED:1.0"))
				{
					throw org.csapi.fw.P_SERVICE_ACCESS_DENIEDHelper.read(_ax.getInputStream());
				}
				else 
		...
		else
		{
			...
			IpServiceAgreementManagementOperations _localServant = (IpServiceAgreementManagementOperations)_so.servant;
			org.csapi.fw.TpSignatureAndServiceMgr _result;			try
			{
	...
	public void initiateSignServiceAgreement(java.lang.String serviceToken) throws org.csapi.TpCommonExceptions,org.csapi.fw.P_INVALID_SERVICE_TOKEN,org.csapi.fw.P_SERVICE_ACCESS_DENIED
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "initiateSignServiceAgreement", true);
				_os.write_string(serviceToken);
				_is = _invoke(_os);
				return;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "initiateSignServiceAgreement", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpServiceAgreementManagementOperations _localServant = (IpServiceAgreementManagementOperations)_so.servant;
			try
			{
			_localServant.initiateSignServiceAgreement(serviceToken);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public java.lang.String selectService(java.lang.String serviceID) throws org.csapi.fw.P_INVALID_SERVICE_ID,org.csapi.TpCommonExceptions,org.csapi.fw.P_ACCESS_DENIED,org.csapi.fw.P_SERVICE_ACCESS_DENIED
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "selectService", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "selectService", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpServiceAgreementManagementOperations _localServant = (IpServiceAgreementManagementOperations)_so.servant;
			java.lang.String _result;			try
			{
			_result = _localServant.selectService(serviceID);
			}
			finally
			{
				_servant_postinvoke(_so);
