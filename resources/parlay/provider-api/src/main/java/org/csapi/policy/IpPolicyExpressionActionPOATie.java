...
public class IpPolicyExpressionActionPOATie
	extends IpPolicyExpressionActionPOA
{
	private IpPolicyExpressionActionOperations _delegate;

	private POA _poa;
	public IpPolicyExpressionActionPOATie(IpPolicyExpressionActionOperations delegate)
	{
		_delegate = delegate;
	}
	public IpPolicyExpressionActionPOATie(IpPolicyExpressionActionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public IpPolicyExpressionActionOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(IpPolicyExpressionActionOperations delegate)
	{
		_delegate = delegate;
	}
