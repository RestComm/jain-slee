...
public final class TpCallAppInfoTypeHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.csapi.cc.TpCallAppInfoTypeHelper.id(),"TpCallAppInfoType",new String[]{"P_CALL_APP_UNDEFINED","P_CALL_APP_ALERTING_MECHANISM","P_CALL_APP_NETWORK_ACCESS_TYPE","P_CALL_APP_TELE_SERVICE","P_CALL_APP_BEARER_SERVICE","P_CALL_APP_PARTY_CATEGORY","P_CALL_APP_PRESENTATION_ADDRESS","P_CALL_APP_GENERIC_INFO","P_CALL_APP_ADDITIONAL_ADDRESS","P_CALL_APP_ORIGINAL_DESTINATION_ADDRESS","P_CALL_APP_REDIRECTING_ADDRESS","P_CALL_APP_HIGH_PROBABILITY_COMPLETION","P_CALL_APP_CARRIER"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.csapi.cc.TpCallAppInfoType s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.csapi.cc.TpCallAppInfoType extract (final org.omg.CORBA.Any any)
	{
	...
	{
		return "IDL:org/csapi/cc/TpCallAppInfoType:1.0";
	}
