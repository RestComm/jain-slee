...
{
	private IpPolicyExpressionConditionOperations _delegate;
	...
	public IpPolicyExpressionConditionPOATie(IpPolicyExpressionConditionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
