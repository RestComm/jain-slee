...
public abstract class IpVPrNPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.csapi.cm.IpVPrNOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "setCallbackWithSessionID", new java.lang.Integer(0));
		m_opsHash.put ( "getVPrP", new java.lang.Integer(1));
		m_opsHash.put ( "createVPrP", new java.lang.Integer(2));
		m_opsHash.put ( "getVPrPList", new java.lang.Integer(3));
		m_opsHash.put ( "setCallback", new java.lang.Integer(4));
		m_opsHash.put ( "deleteVPrP", new java.lang.Integer(5));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				_out = handler.createReply();
				org.csapi.IpInterfaceHelper.write(_out,getVPrP(_arg0));
			}
			...
			catch(org.csapi.cm.P_ILLEGAL_VPRPID _ex2)
			{
				_out = handler.createExceptionReply();
				org.csapi.cm.P_ILLEGAL_VPRPIDHelper.write(_out, _ex2);
			}
				break;
			}
			case 2: // createVPrP
			...
			try
			{
				org.csapi.IpInterface _arg0=org.csapi.IpInterfaceHelper.read(_input);
				_out = handler.createReply();
				org.csapi.IpInterfaceHelper.write(_out,createVPrP(_arg0));
			}
			...
			catch(org.csapi.cm.P_UNKNOWN_INTERFACE _ex1)
			{
				_out = handler.createExceptionReply();
				org.csapi.cm.P_UNKNOWN_INTERFACEHelper.write(_out, _ex1);
			}
			catch(org.csapi.cm.P_ILLEGAL_REF_VALUE _ex2)
			{
				_out = handler.createExceptionReply();
				org.csapi.cm.P_ILLEGAL_REF_VALUEHelper.write(_out, _ex2);
			}
				break;
			}
			case 3: // getVPrPList
			...
			{
				_out = handler.createReply();
				org.csapi.TpStringListHelper.write(_out,getVPrPList());
			}
			catch(org.csapi.TpCommonExceptions _ex0)
			{
				_out = handler.createExceptionReply();
			...
			catch(org.csapi.cm.P_UNKNOWN_VPRP _ex1)
			{
				_out = handler.createExceptionReply();
				org.csapi.cm.P_UNKNOWN_VPRPHelper.write(_out, _ex1);
			}
				break;
			}
			case 4: // setCallback
			...
			catch(org.csapi.cm.P_CANT_DELETE_VPRP _ex1)
			{
				_out = handler.createExceptionReply();
				org.csapi.cm.P_CANT_DELETE_VPRPHelper.write(_out, _ex1);
			}
