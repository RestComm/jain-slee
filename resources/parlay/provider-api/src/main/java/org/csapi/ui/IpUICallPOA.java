...
public abstract class IpUICallPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.csapi.ui.IpUICallOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "recordMessageReq", new java.lang.Integer(2));
		m_opsHash.put ( "sendInfoAndCollectReq", new java.lang.Integer(3));
		m_opsHash.put ( "deleteMessageReq", new java.lang.Integer(4));
		m_opsHash.put ( "release", new java.lang.Integer(5));
		m_opsHash.put ( "setOriginatingAddress", new java.lang.Integer(6));
		m_opsHash.put ( "abortActionReq", new java.lang.Integer(7));
		m_opsHash.put ( "getOriginatingAddress", new java.lang.Integer(8));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 2: // recordMessageReq
			{
			try
			{
				int _arg0=_input.read_long();
				org.csapi.ui.TpUIInfo _arg1=org.csapi.ui.TpUIInfoHelper.read(_input);
				org.csapi.ui.TpUIMessageCriteria _arg2=org.csapi.ui.TpUIMessageCriteriaHelper.read(_input);
				_out = handler.createReply();
				_out.write_long(recordMessageReq(_arg0,_arg1,_arg2));
			}
			catch(org.csapi.ui.P_ILLEGAL_ID _ex0)
			{
				_out = handler.createExceptionReply();
			...
			try
			{
				...
				_out = handler.createReply();
				_out.write_long(deleteMessageReq(_arg0,_arg1));
			}
			catch(org.csapi.ui.P_ILLEGAL_ID _ex0)
			{
				_out = handler.createExceptionReply();
			...
			catch(org.csapi.ui.P_ID_NOT_FOUND _ex2)
			{
				_out = handler.createExceptionReply();
				org.csapi.ui.P_ID_NOT_FOUNDHelper.write(_out, _ex2);
			}
