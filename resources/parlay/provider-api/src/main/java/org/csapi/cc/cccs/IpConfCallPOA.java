...
public abstract class IpConfCallPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.csapi.cc.cccs.IpConfCallOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getSubConferences", new java.lang.Integer(2));
		m_opsHash.put ( "createSubConference", new java.lang.Integer(3));
		m_opsHash.put ( "createAndRouteCallLegReq", new java.lang.Integer(4));
		m_opsHash.put ( "superviseVolumeReq", new java.lang.Integer(5));
		m_opsHash.put ( "getInfoReq", new java.lang.Integer(6));
		m_opsHash.put ( "getConferenceAddress", new java.lang.Integer(7));
		m_opsHash.put ( "createCallLeg", new java.lang.Integer(8));
		m_opsHash.put ( "deassignCall", new java.lang.Integer(9));
		m_opsHash.put ( "release", new java.lang.Integer(10));
		m_opsHash.put ( "setCallbackWithSessionID", new java.lang.Integer(11));
		m_opsHash.put ( "setAdviceOfCharge", new java.lang.Integer(12));
		m_opsHash.put ( "setChargePlan", new java.lang.Integer(13));
		m_opsHash.put ( "leaveMonitorReq", new java.lang.Integer(14));
		m_opsHash.put ( "superviseReq", new java.lang.Integer(15));
	}
	private String[] ids = {"IDL:org/csapi/cc/cccs/IpConfCall:1.0","IDL:org/csapi/IpInterface:1.0","IDL:org/csapi/cc/mpccs/IpMultiPartyCall:1.0","IDL:org/csapi/IpService:1.0","IDL:org/csapi/cc/mmccs/IpMultiMediaCall:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 2: // getSubConferences
			{
			try
			{
				int _arg0=_input.read_long();
				_out = handler.createReply();
				org.csapi.cc.cccs.TpSubConfCallIdentifierSetHelper.write(_out,getSubConferences(_arg0));
			}
			catch(org.csapi.TpCommonExceptions _ex0)
			{
				_out = handler.createExceptionReply();
			...
			case 3: // createSubConference
			{
			try
			{
				int _arg0=_input.read_long();
				org.csapi.cc.cccs.IpAppSubConfCall _arg1=org.csapi.cc.cccs.IpAppSubConfCallHelper.read(_input);
				org.csapi.cc.cccs.TpConfPolicy _arg2=org.csapi.cc.cccs.TpConfPolicyHelper.read(_input);
				_out = handler.createReply();
				org.csapi.cc.cccs.TpSubConfCallIdentifierHelper.write(_out,createSubConference(_arg0,_arg1,_arg2));
			}
			catch(org.csapi.TpCommonExceptions _ex0)
			{
				_out = handler.createExceptionReply();
			...
			case 4: // createAndRouteCallLegReq
			{
			try
			{
				int _arg0=_input.read_long();
			...
			case 7: // getConferenceAddress
			{
			try
			{
				int _arg0=_input.read_long();
				_out = handler.createReply();
				org.csapi.TpAddressHelper.write(_out,getConferenceAddress(_arg0));
			}
			catch(org.csapi.TpCommonExceptions _ex0)
			{
				_out = handler.createExceptionReply();
			...
			case 11: // setCallbackWithSessionID
			{
			try
			{
				org.csapi.IpInterface _arg0=org.csapi.IpInterfaceHelper.read(_input);
			...
			case 14: // leaveMonitorReq
			{
			try
			{
				int _arg0=_input.read_long();
				_out = handler.createReply();
				leaveMonitorReq(_arg0);
			}
			catch(org.csapi.TpCommonExceptions _ex0)
			{
				_out = handler.createExceptionReply();
