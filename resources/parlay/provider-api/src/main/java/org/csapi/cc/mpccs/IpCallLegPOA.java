...
public abstract class IpCallLegPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.csapi.cc.mpccs.IpCallLegOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "setCallback", new java.lang.Integer(0));
		m_opsHash.put ( "deassign", new java.lang.Integer(1));
		m_opsHash.put ( "getInfoReq", new java.lang.Integer(2));
		m_opsHash.put ( "eventReportReq", new java.lang.Integer(3));
		m_opsHash.put ( "attachMediaReq", new java.lang.Integer(4));
		m_opsHash.put ( "getCall", new java.lang.Integer(5));
		m_opsHash.put ( "getCurrentDestinationAddress", new java.lang.Integer(6));
		m_opsHash.put ( "continueProcessing", new java.lang.Integer(7));
		m_opsHash.put ( "routeReq", new java.lang.Integer(8));
		m_opsHash.put ( "release", new java.lang.Integer(9));
		m_opsHash.put ( "detachMediaReq", new java.lang.Integer(10));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 6: // getCurrentDestinationAddress
			{
			try
			{
				int _arg0=_input.read_long();
