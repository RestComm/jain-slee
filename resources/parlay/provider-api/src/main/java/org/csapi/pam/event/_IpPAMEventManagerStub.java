...
public class _IpPAMEventManagerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.csapi.pam.event.IpPAMEventManager
{
	...
	public final static java.lang.Class _opsClass = org.csapi.pam.event.IpPAMEventManagerOperations.class;
	public byte[] getAuthToken(org.csapi.TpAttribute[] askerData) throws org.csapi.TpCommonExceptions,org.csapi.pam.P_PAM_INVALID_CREDENTIAL
	{
		...
		else
		{
			...
			IpPAMEventManagerOperations _localServant = (IpPAMEventManagerOperations)_so.servant;
			byte[] _result;			try
			{
