...
{
	private IpPAMPresenceAvailabilityManagerOperations _delegate;
	...
	public IpPAMPresenceAvailabilityManagerPOATie(IpPAMPresenceAvailabilityManagerOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
