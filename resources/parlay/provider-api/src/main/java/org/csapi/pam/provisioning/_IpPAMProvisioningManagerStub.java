...
public class _IpPAMProvisioningManagerStub
	...
	implements org.csapi.pam.provisioning.IpPAMProvisioningManager
{
	...
	public final static java.lang.Class _opsClass = org.csapi.pam.provisioning.IpPAMProvisioningManagerOperations.class;
	public byte[] getAuthToken(org.csapi.TpAttribute[] askerData) throws org.csapi.TpCommonExceptions,org.csapi.pam.P_PAM_INVALID_CREDENTIAL
	{
		...
		else
		{
			...
			IpPAMProvisioningManagerOperations _localServant = (IpPAMProvisioningManagerOperations)_so.servant;
			byte[] _result;			try
			{
