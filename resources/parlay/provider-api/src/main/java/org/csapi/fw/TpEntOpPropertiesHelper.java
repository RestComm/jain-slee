...
/**
 *	Generated from IDL definition of alias "TpEntOpProperties"
 *	@author JacORB IDL compiler 
 */

public final class TpEntOpPropertiesHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.csapi.fw.TpEntOpPropertiesHelper.id(), "TpEntOpProperties",org.csapi.fw.TpPropertyListHelper.type());
		}
		return _type;
	}
	...
	{
		return "IDL:org/csapi/fw/TpEntOpProperties:1.0";
	}
