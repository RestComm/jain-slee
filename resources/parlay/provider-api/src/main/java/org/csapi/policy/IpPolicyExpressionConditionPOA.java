...
public abstract class IpPolicyExpressionConditionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.csapi.policy.IpPolicyExpressionConditionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setAttribute", new java.lang.Integer(4));
		m_opsHash.put ( "getAttribute", new java.lang.Integer(5));
	}
	private String[] ids = {"IDL:org/csapi/policy/IpPolicyExpressionCondition:1.0","IDL:org/csapi/policy/IpPolicyCondition:1.0","IDL:org/csapi/policy/IpPolicy:1.0","IDL:org/csapi/IpInterface:1.0"};
	public org.csapi.policy.IpPolicyExpressionCondition _this()
	{
		return org.csapi.policy.IpPolicyExpressionConditionHelper.narrow(_this_object());
	}
	public org.csapi.policy.IpPolicyExpressionCondition _this(org.omg.CORBA.ORB orb)
	{
		return org.csapi.policy.IpPolicyExpressionConditionHelper.narrow(_this_object(orb));
	}
