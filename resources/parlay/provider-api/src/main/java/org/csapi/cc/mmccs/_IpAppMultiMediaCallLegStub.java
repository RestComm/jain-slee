...
public class _IpAppMultiMediaCallLegStub
	...
	implements org.csapi.cc.mmccs.IpAppMultiMediaCallLeg
{
	...
	public final static java.lang.Class _opsClass = org.csapi.cc.mmccs.IpAppMultiMediaCallLegOperations.class;
	public void attachMediaRes(int callLegSessionID)
	{
		...
		else
		{
			...
			IpAppMultiMediaCallLegOperations _localServant = (IpAppMultiMediaCallLegOperations)_so.servant;
			try
			{
	...
	public void mediaStreamMonitorRes(int callLegSessionID, org.csapi.cc.mmccs.TpMediaStream[] streams, org.csapi.cc.mmccs.TpMediaStreamEventType type)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "mediaStreamMonitorRes", true);
				_os.write_long(callLegSessionID);
				org.csapi.cc.mmccs.TpMediaStreamSetHelper.write(_os,streams);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "mediaStreamMonitorRes", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpAppMultiMediaCallLegOperations _localServant = (IpAppMultiMediaCallLegOperations)_so.servant;
			try
			{
			_localServant.mediaStreamMonitorRes(callLegSessionID,streams,type);
			}
			finally
			{
				_servant_postinvoke(_so);
