...
public abstract class IpMultiPartyCallPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.csapi.cc.mpccs.IpMultiPartyCallOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "createCallLeg", new java.lang.Integer(4));
		m_opsHash.put ( "deassignCall", new java.lang.Integer(5));
		m_opsHash.put ( "release", new java.lang.Integer(6));
		m_opsHash.put ( "setCallbackWithSessionID", new java.lang.Integer(7));
		m_opsHash.put ( "setAdviceOfCharge", new java.lang.Integer(8));
		m_opsHash.put ( "setChargePlan", new java.lang.Integer(9));
		m_opsHash.put ( "superviseReq", new java.lang.Integer(10));
	}
