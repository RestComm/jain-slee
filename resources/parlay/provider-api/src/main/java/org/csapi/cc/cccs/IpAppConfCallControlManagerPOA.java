...
public abstract class IpAppConfCallControlManagerPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.csapi.cc.cccs.IpAppConfCallControlManagerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "reportMediaNotification", new java.lang.Integer(2));
		m_opsHash.put ( "managerResumed", new java.lang.Integer(3));
		m_opsHash.put ( "managerInterrupted", new java.lang.Integer(4));
		m_opsHash.put ( "callOverloadEncountered", new java.lang.Integer(5));
		m_opsHash.put ( "conferenceCreated", new java.lang.Integer(6));
		m_opsHash.put ( "reportNotification", new java.lang.Integer(7));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 2: // reportMediaNotification
			{
			...
			case 6: // conferenceCreated
			{
				org.csapi.cc.cccs.TpConfCallIdentifier _arg0=org.csapi.cc.cccs.TpConfCallIdentifierHelper.read(_input);
				_out = handler.createReply();
				org.csapi.cc.cccs.IpAppConfCallHelper.write(_out,conferenceCreated(_arg0));
				break;
			}
			case 7: // reportNotification
			{
