...
public abstract class IpUserLocationPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.csapi.mm.ul.IpUserLocationOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "setCallbackWithSessionID", new java.lang.Integer(0));
		m_opsHash.put ( "periodicLocationReportingStop", new java.lang.Integer(1));
		m_opsHash.put ( "periodicLocationReportingStartReq", new java.lang.Integer(2));
		m_opsHash.put ( "locationReportReq", new java.lang.Integer(3));
		m_opsHash.put ( "extendedLocationReportReq", new java.lang.Integer(4));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 1: // periodicLocationReportingStop
			{
			try
			{
			...
			case 4: // extendedLocationReportReq
			{
			try
			{
				org.csapi.mm.ul.IpAppUserLocation _arg0=org.csapi.mm.ul.IpAppUserLocationHelper.read(_input);
