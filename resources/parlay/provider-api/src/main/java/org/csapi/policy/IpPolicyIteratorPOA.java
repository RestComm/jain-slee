...
public abstract class IpPolicyIteratorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.csapi.policy.IpPolicyIteratorOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "setAttributes", new java.lang.Integer(0));
		m_opsHash.put ( "getAttributes", new java.lang.Integer(1));
		m_opsHash.put ( "getList", new java.lang.Integer(2));
		m_opsHash.put ( "getAttribute", new java.lang.Integer(3));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				_out = handler.createReply();
				org.csapi.TpStringSetHelper.write(_out,getList(_arg0,_arg1));
			}
			catch(org.csapi.TpCommonExceptions _ex0)
			{
				_out = handler.createExceptionReply();
