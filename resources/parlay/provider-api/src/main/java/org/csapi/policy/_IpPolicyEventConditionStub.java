...
public class _IpPolicyEventConditionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.csapi.policy.IpPolicyEventCondition
{
	private String[] ids = {"IDL:org/csapi/policy/IpPolicyEventCondition:1.0","IDL:org/csapi/policy/IpPolicyCondition:1.0","IDL:org/csapi/policy/IpPolicy:1.0","IDL:org/csapi/IpInterface:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.csapi.policy.IpPolicyEventConditionOperations.class;
	public org.csapi.policy.IpPolicyRepository getParentRepository() throws org.csapi.TpCommonExceptions
	{
		...
		else
		{
			...
			IpPolicyEventConditionOperations _localServant = (IpPolicyEventConditionOperations)_so.servant;
