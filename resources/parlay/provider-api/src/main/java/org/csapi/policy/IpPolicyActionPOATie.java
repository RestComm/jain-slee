...
public class IpPolicyActionPOATie
	extends IpPolicyActionPOA
{
	private IpPolicyActionOperations _delegate;

	private POA _poa;
	public IpPolicyActionPOATie(IpPolicyActionOperations delegate)
	{
		_delegate = delegate;
	}
	public IpPolicyActionPOATie(IpPolicyActionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public void _delegate(IpPolicyActionOperations delegate)
	{
		_delegate = delegate;
	}
