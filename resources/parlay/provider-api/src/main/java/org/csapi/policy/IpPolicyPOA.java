...
public abstract class IpPolicyPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.csapi.policy.IpPolicyOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setAttribute", new java.lang.Integer(2));
		m_opsHash.put ( "getAttribute", new java.lang.Integer(3));
	}
	private String[] ids = {"IDL:org/csapi/policy/IpPolicy:1.0","IDL:org/csapi/IpInterface:1.0"};
