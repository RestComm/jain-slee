...
/**
 *	Generated from IDL definition of alias "TpAny"
 *	@author JacORB IDL compiler 
 */

public final class TpAnyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.csapi.TpAnyHelper.id(), "TpAny",org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(11)));
		}
		return _type;
	}
	...
	{
		return "IDL:org/csapi/TpAny:1.0";
	}
