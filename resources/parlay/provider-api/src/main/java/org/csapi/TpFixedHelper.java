...
/**
 *	Generated from IDL definition of alias "TpFixed"
 *	@author JacORB IDL compiler 
 */

public final class TpFixedHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.csapi.TpFixedHelper.id(), "TpFixed",org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(6)));
		}
		return _type;
	}
	...
	{
		return "IDL:org/csapi/TpFixed:1.0";
	}
