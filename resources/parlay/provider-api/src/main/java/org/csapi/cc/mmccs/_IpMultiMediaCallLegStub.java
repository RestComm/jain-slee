...
public class _IpMultiMediaCallLegStub
	...
	implements org.csapi.cc.mmccs.IpMultiMediaCallLeg
{
	...
	public final static java.lang.Class _opsClass = org.csapi.cc.mmccs.IpMultiMediaCallLegOperations.class;
	public void routeReq(int callLegSessionID, org.csapi.TpAddress targetAddress, org.csapi.TpAddress originatingAddress, org.csapi.cc.TpCallAppInfo[] appInfo, org.csapi.cc.TpCallLegConnectionProperties connectionProperties) throws org.csapi.P_INVALID_NETWORK_STATE,org.csapi.TpCommonExceptions,org.csapi.P_INVALID_ADDRESS,org.csapi.P_INVALID_SESSION_ID,org.csapi.P_UNSUPPORTED_ADDRESS_PLAN
	{
		...
		else
		{
			...
			IpMultiMediaCallLegOperations _localServant = (IpMultiMediaCallLegOperations)_so.servant;
			try
			{
	...
	public org.csapi.cc.mmccs.TpMediaStream[] getMediaStreams(int callLegSessionID) throws org.csapi.TpCommonExceptions,org.csapi.P_INVALID_SESSION_ID
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getMediaStreams", true);
				_os.write_long(callLegSessionID);
				_is = _invoke(_os);
				org.csapi.cc.mmccs.TpMediaStream[] _result = org.csapi.cc.mmccs.TpMediaStreamSetHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getMediaStreams", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpMultiMediaCallLegOperations _localServant = (IpMultiMediaCallLegOperations)_so.servant;
			org.csapi.cc.mmccs.TpMediaStream[] _result;			try
			{
			_result = _localServant.getMediaStreams(callLegSessionID);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void mediaStreamAllow(int callLegSessionID, int[] mediaStreamList) throws org.csapi.TpCommonExceptions,org.csapi.P_INVALID_SESSION_ID
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "mediaStreamAllow", true);
				_os.write_long(callLegSessionID);
				org.csapi.TpSessionIDSetHelper.write(_os,mediaStreamList);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "mediaStreamAllow", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpMultiMediaCallLegOperations _localServant = (IpMultiMediaCallLegOperations)_so.servant;
			try
			{
			_localServant.mediaStreamAllow(callLegSessionID,mediaStreamList);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void mediaStreamMonitorReq(int callLegSessionID, org.csapi.cc.mmccs.TpMediaStreamRequest[] mediaStreamEventCriteria) throws org.csapi.P_INVALID_EVENT_TYPE,org.csapi.TpCommonExceptions,org.csapi.P_INVALID_SESSION_ID,org.csapi.P_INVALID_CRITERIA
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "mediaStreamMonitorReq", true);
				_os.write_long(callLegSessionID);
				org.csapi.cc.mmccs.TpMediaStreamRequestSetHelper.write(_os,mediaStreamEventCriteria);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "mediaStreamMonitorReq", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			IpMultiMediaCallLegOperations _localServant = (IpMultiMediaCallLegOperations)_so.servant;
			try
			{
			_localServant.mediaStreamMonitorReq(callLegSessionID,mediaStreamEventCriteria);
			}
			finally
			{
				_servant_postinvoke(_so);
