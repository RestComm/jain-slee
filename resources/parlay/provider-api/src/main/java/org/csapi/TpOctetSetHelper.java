...
public final class TpOctetSetHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.csapi.TpOctetSetHelper.id(), "TpOctetSet",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.csapi.TpOctetHelper.type()));
		}
		return _type;
	}
