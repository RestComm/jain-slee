...
/**
 *	Generated from IDL definition of alias "TpServiceRequestor"
 *	@author JacORB IDL compiler 
 */

public final class TpServiceRequestorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.csapi.fw.TpServiceRequestorHelper.id(), "TpServiceRequestor",org.csapi.fw.TpPersonHelper.type());
		}
		return _type;
	}
	...
	{
		return "IDL:org/csapi/fw/TpServiceRequestor:1.0";
	}
