...
public class IpPolicyConditionPOATie
	extends IpPolicyConditionPOA
{
	private IpPolicyConditionOperations _delegate;

	private POA _poa;
	public IpPolicyConditionPOATie(IpPolicyConditionOperations delegate)
	{
		_delegate = delegate;
	}
	public IpPolicyConditionPOATie(IpPolicyConditionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	public org.csapi.policy.IpPolicyCondition _this()
	{
		return org.csapi.policy.IpPolicyConditionHelper.narrow(_this_object());
	}
	public org.csapi.policy.IpPolicyCondition _this(org.omg.CORBA.ORB orb)
	{
		return org.csapi.policy.IpPolicyConditionHelper.narrow(_this_object(orb));
	}
	public IpPolicyConditionOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(IpPolicyConditionOperations delegate)
	{
		_delegate = delegate;
	}
