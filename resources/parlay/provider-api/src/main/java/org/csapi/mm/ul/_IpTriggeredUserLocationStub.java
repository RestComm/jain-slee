...
public class _IpTriggeredUserLocationStub
	...
	implements org.csapi.mm.ul.IpTriggeredUserLocation
{
	...
	public final static java.lang.Class _opsClass = org.csapi.mm.ul.IpTriggeredUserLocationOperations.class;
	public int triggeredLocationReportingStartReq(org.csapi.mm.ul.IpAppTriggeredUserLocation appLocation, org.csapi.TpAddress[] users, org.csapi.mm.TpLocationRequest request, org.csapi.mm.TpLocationTrigger[] triggers) throws org.csapi.P_INVALID_INTERFACE_TYPE,org.csapi.P_INFORMATION_NOT_AVAILABLE,org.csapi.mm.P_REQUESTED_RESPONSE_TIME_CANNOT_BE_DELIVERED,org.csapi.TpCommonExceptions,org.csapi.P_APPLICATION_NOT_ACTIVATED,org.csapi.mm.P_TRIGGER_CONDITIONS_NOT_SUBSCRIBED,org.csapi.mm.P_REQUESTED_ACCURACY_CANNOT_BE_DELIVERED,org.csapi.P_UNKNOWN_SUBSCRIBER
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.csapi.mm.ul.IpAppTriggeredUserLocationHelper.write(_os,appLocation);
				org.csapi.TpAddressSetHelper.write(_os,users);
				org.csapi.mm.TpLocationRequestHelper.write(_os,request);
				org.csapi.mm.TpLocationTriggerSetHelper.write(_os,triggers);
				_is = _invoke(_os);
			...
			catch( org.omg.CORBA.portable.ApplicationException _ax )
			{
				...
				else if( _id.equals("IDL:org/csapi/mm/P_TRIGGER_CONDITIONS_NOT_SUBSCRIBED:1.0"))
				{
					throw org.csapi.mm.P_TRIGGER_CONDITIONS_NOT_SUBSCRIBEDHelper.read(_ax.getInputStream());
				}
		...
		else
		{
			...
			IpTriggeredUserLocationOperations _localServant = (IpTriggeredUserLocationOperations)_so.servant;
			int _result;			try
			{
			_result = _localServant.triggeredLocationReportingStartReq(appLocation,users,request,triggers);
			}
			finally
			{
