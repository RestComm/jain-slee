...
public abstract class IpAppSubConfCallPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.csapi.cc.cccs.IpAppSubConfCallOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "floorRequest", new java.lang.Integer(2));
		m_opsHash.put ( "superviseRes", new java.lang.Integer(3));
		m_opsHash.put ( "getInfoRes", new java.lang.Integer(4));
		m_opsHash.put ( "superviseVolumeRes", new java.lang.Integer(5));
		m_opsHash.put ( "callEnded", new java.lang.Integer(6));
		m_opsHash.put ( "getInfoErr", new java.lang.Integer(7));
		m_opsHash.put ( "superviseVolumeErr", new java.lang.Integer(8));
		m_opsHash.put ( "chairSelection", new java.lang.Integer(9));
	}
