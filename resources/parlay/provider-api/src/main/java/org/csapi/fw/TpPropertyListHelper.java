...
public final class TpPropertyListHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.csapi.fw.TpPropertyListHelper.id(), "TpPropertyList",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.csapi.fw.TpPropertyHelper.type()));
		}
		return _type;
	}
	...
	{
		return "IDL:org/csapi/fw/TpPropertyList:1.0";
	}
	public static org.csapi.fw.TpProperty[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.csapi.fw.TpProperty[_l_result15];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=org.csapi.fw.TpPropertyHelper.read(_in);
		}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, org.csapi.fw.TpProperty[] _s)
	{
		...
		{
			org.csapi.fw.TpPropertyHelper.write(_out,_s[i]);
		}
