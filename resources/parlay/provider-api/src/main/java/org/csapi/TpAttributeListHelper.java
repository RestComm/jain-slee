...
public final class TpAttributeListHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.csapi.TpAttributeListHelper.id(), "TpAttributeList",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.csapi.TpAttributeHelper.type()));
		}
		return _type;
	}
	...
	{
		return "IDL:org/csapi/TpAttributeList:1.0";
	}
	public static org.csapi.TpAttribute[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.csapi.TpAttribute[_l_result64];
