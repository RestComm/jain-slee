 ...
 * 
 */
public class AbortActionErrHandler implements Runnable {
    /**
     * Log4J Logger for this class.
     */
    private static final Log logger = LogFactory
            .getLog(AbortActionErrHandler.class);
    ...
    public AbortActionErrHandler(UIManager uiManager,
    ...
    public void run() {
        try {
            if (uiManager != null) {
                ...
                if (uiCall != null) {
                    uiCall.abortActionErr(userInteractionSessionID,
                            assignmentID, error);
                } else {
            ...
            // Catch all
            logger.error("AbortActionErrHandler failed", e);
        }
