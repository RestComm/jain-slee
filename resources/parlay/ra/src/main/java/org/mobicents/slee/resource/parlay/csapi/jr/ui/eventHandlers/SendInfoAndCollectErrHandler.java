 ...
 * 
 */
public class SendInfoAndCollectErrHandler implements Runnable {
    /**
     * Log4J Logger for this class.
     */
    private static final Log logger = LogFactory
            .getLog(SendInfoAndCollectErrHandler.class);
    ...
    public SendInfoAndCollectErrHandler(UIManager uiManager,
    ...
    public void run() {
        try {
            if (uiManager != null) {
                ...
                if (ui != null) {
                    ui.sendInfoAndCollectErr(userInteractionSessionID,
                            assignmentID, error);
                } else {
            ...
            // Catch all
            logger.error("SendInfoAndCollectErrHandler failed", e);
        }
