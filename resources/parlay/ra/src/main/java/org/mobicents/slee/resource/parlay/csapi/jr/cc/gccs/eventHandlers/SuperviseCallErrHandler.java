 ...
 *
 **/
public class SuperviseCallErrHandler implements Runnable {
    /**
     * Log4J Logger for this class.
     */
    private static final Log logger = LogFactory
        .getLog(SuperviseCallErrHandler.class);
     ...
     */
    public SuperviseCallErrHandler(CallControlManager callControlManager, int callSessionID, TpCallError errorIndication) {
        super();
    ...
    public void run() {
        try {
            if (callControlManager != null) {
	            ...
	            if(call != null ) {
	                call.superviseCallErr(callSessionID, errorIndication);
	            }
            }
        } catch (RuntimeException e) {
            // Catch all
            logger.error("SuperviseCallErrHandler failed", e);
        }
    }
