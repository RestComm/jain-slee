...
/**
 * Base interface for Rx Session Activities.
 *
 * @author <a href="mailto:brainslog@gmail.com"> Alexandre Mendonca </a>
 * @author <a href="mailto:baranowb@gmail.com"> Bartosz Baranowski </a>
 * @author <a href="mailto:richard.good@smilecoms.com"> Richard Good </a>
 */
public interface RxSessionActivity {

  /**
   * Provides session state information.
   *
   * @return instance of {@link RxSessionState}
   */
  ...
  /**
   * Returns the session ID of the Rx session, which uniquely
