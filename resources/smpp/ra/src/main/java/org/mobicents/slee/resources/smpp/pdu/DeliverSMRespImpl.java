 ...
 *
 */
public class DeliverSMRespImpl extends DeliverSMResp {

	private long commandId = SmppRequest.DELIVER_SM_RESP;
	private long commandStatus = 0;
	private long sequenceNumber = -1;

	private String messageId;
	
	public DeliverSMRespImpl(long commandStatus){
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final DeliverSMRespImpl other = (DeliverSMRespImpl) obj;
