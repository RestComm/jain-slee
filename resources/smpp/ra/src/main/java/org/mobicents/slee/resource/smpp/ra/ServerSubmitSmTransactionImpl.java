 ...
 * @author Oleg Kulikov
 */
public class ServerSubmitSmTransactionImpl extends AbstractTransaction  implements ServerTransaction {
     ...
     */
    public ServerSubmitSmTransactionImpl(int id, SmppDialogImpl dialog, ShortMessage message) {
        super(id, dialog);
    ...
    public void respond(int status) throws IOException {
        ...
        try {
            resp = (SubmitSMResp) dialog.resourceAdaptor.smscConnection.newInstance(SMPPPacket.SUBMIT_SM_RESP);
