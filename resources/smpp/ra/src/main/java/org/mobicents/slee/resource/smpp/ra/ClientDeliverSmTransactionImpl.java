 ...
 * @author Oleg Kulikov
 */
public class ClientDeliverSmTransactionImpl extends AbstractTransaction implements ClientTransaction {
     ...
     */
    public ClientDeliverSmTransactionImpl(int id, SmppDialogImpl dialog) {
        super(id, dialog);
    ...
    public void send(ShortMessage message) throws IOException {
        ...
        try {
            sm = (DeliverSM) connection.newInstance(SMPPPacket.DELIVER_SM);
        ...
        sm.setMessageId(Integer.toString(id));
     ...
     * (Non-javadoc).
     *
     * @see net.java.slee.smpp.ratype.Transaction#getLastActivity
     */
