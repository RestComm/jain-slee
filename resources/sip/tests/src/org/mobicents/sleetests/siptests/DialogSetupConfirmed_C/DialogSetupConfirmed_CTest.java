...
public class DialogSetupConfirmed_CTest extends AbstractSleeTCKTest  implements SipListener{
	//protected static Logger logger=Logger.getLogger(SipResourceAdaptor.class);
	protected static Logger logger=Logger.getLogger(DialogSetupConfirmed_CTest.class);
	...
	public DialogSetupConfirmed_CTest()
	{
		super();
		if(raSETUP)
			return;
