	...
	public void processResponse(ResponseEvent respEvent) {
		...
		if (resp.getStatusCode() == Response.OK && !sentBYE) {
			...
			if (cseq.getMethod().equals(Request.INVITE)) {
				getLog().info(" == GOT OK TO INVITE, SENDING ACK ==");
				Request ackRequest;
				try {
					ackRequest = dial.createAck( ((CSeqHeader)resp.getHeader(CSeqHeader.NAME)).getSeqNumber());
		...
		}else if(resp.getStatusCode() == Response.OK && sentBYE)
		{
			getLog().info(" == GOT OK TO BYE:"+resp+" ==");
		}
	}
