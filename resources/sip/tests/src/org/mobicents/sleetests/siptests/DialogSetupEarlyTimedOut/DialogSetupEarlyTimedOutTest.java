...
public class DialogSetupEarlyTimedOutTest extends AbstractSleeTCKTest  implements SipListener{
	//protected static Logger logger=Logger.getLogger(SipResourceAdaptor.class);
	protected static Logger logger=Logger.getLogger(DialogSetupEarlyTimedOutTest.class);
	...
	public DialogSetupEarlyTimedOutTest()
	{
		super();
		if(raSETUP)
			return;
