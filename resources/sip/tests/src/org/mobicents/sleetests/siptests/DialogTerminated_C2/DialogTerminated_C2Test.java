...
public class DialogTerminated_C2Test extends AbstractSleeTCKTest  implements SipListener{
	//protected static Logger logger=Logger.getLogger(SipResourceAdaptor.class);
	protected static Logger logger=Logger.getLogger(DialogTerminated_C2Test.class);
	...
	public DialogTerminated_C2Test()
	{
		super();
		if(raSETUP)
			return;
	...
	public void processRequest(RequestEvent event) {
		...
		if(req.getMethod().equals(Request.INVITE) && !invitePorcessed)
		{
