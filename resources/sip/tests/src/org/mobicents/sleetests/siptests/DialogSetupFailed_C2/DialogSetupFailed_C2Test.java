...
public class DialogSetupFailed_C2Test extends AbstractSleeTCKTest  implements SipListener{
	//protected static Logger logger=Logger.getLogger(SipResourceAdaptor.class);
	protected static Logger logger=Logger.getLogger(DialogSetupFailed_C2Test.class);
	...
	public DialogSetupFailed_C2Test()
	{
		super();
		if(raSETUP)
			return;
