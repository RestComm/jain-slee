...
public class MessageOk_CTest extends AbstractSleeTCKTest  implements SipListener{
	//protected static Logger logger=Logger.getLogger(SipResourceAdaptor.class);
	protected static Logger logger=Logger.getLogger(MessageOk_CTest.class);
	
	
	
	private static boolean raSETUP=false;
	private static SipRaCreator creator=null;
	public MessageOk_CTest()
	{
		super();
		if(raSETUP)
			return;
	...
	public void processRequest(RequestEvent event) {
		...
		Response resp=null;
		try {
			resp=binder.getMessageFactory().createResponse(Response.OK,event.getRequest());
	...
	public void processTimeout(TimeoutEvent arg0) {
		...
		try {
			...
			result.setError(e);// TODO Auto-generated catch block
			e.printStackTrace();
		}
	}
