...
public abstract class DialogSetupConfirmedTimedOutTestSbb extends BaseTCKSbb {
	...
	public abstract boolean getSetupTimedOutReceived();
	public abstract void setSetupTimedOutReceived(boolean flag);
	...
	public void onTimeEvent(javax.slee.facilities.TimerEvent event,
			ActivityContextInterface aci) {
		if (!getSetupConfirmedReceived() || !getSetupTimedOutReceived())
			try {
