 ...
 * this PDU to specify the sender, receiver and text of the short message. Other
 * attributes include message priority, data coding scheme, validity period etc.
 * </p>
 * 
 * @author amit bhayani
 * 
...
public interface SubmitSM extends SmppRequest {
	...
	public abstract void setScheduleDeliveryTime(SMPPDate smppDate);
