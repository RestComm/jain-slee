...
public class LatchingIndication implements Enumerated, Serializable {
  ...
  public static final LatchingIndication LATCH = new LatchingIndication(_LATCH);
  public static final LatchingIndication RELATCH = new LatchingIndication(_RELATCH);

  private int value = 0;

  private LatchingIndication(int v) {
    value = v;
  }
  ...
  public static LatchingIndication fromInt(int type) {
    switch (type) {
      ...
      case _RELATCH:
        return RELATCH;
      default:
        throw new IllegalArgumentException("Invalid Latching Indication value: " + type);
    }
  }
