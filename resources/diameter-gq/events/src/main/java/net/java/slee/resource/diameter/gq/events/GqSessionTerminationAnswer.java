 ...
 */
public interface GqSessionTerminationAnswer extends DiameterMessage {
  ...
  /**
   * Returns the value of the Redirect-Max-Cache-Time AVP, of type Unsigned32. Use {@link #hasRedirectMaxCacheTime()} to check the existence
   * of this AVP.
   * 
