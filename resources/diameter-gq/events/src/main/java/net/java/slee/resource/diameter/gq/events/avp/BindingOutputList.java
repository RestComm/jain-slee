 ...
 * The Binding-input-list AVP (AVP Code 452) is of type Grouped AVP and holds a list transport addresses which is the result of the binding operation
 * performed by transport plane functions 
 * 
