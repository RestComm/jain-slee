 ...
 * @author amit bhayani
 */
public class UnstructuredSSResponseWrapper extends SupplementaryMessageWrapper<UnstructuredSSResponse> implements
		UnstructuredSSResponse {

	private static final String EVENT_TYPE_NAME = "ss7.map.service.suplementary.UNSTRUCTURED_SS_RESPONSE";

	/**
	 * @param mAPDialog
	 */
	public UnstructuredSSResponseWrapper(MAPDialogSupplementaryWrapper mAPDialog, UnstructuredSSResponse res) {
	...
	public String toString() {
		return "UnstructuredSSResponseWrapper [wrapped=" + this.wrappedEvent + "]";
	}
