 ...
 * 
 */
public class ProcessUnstructuredSSResponseWrapper extends
		SupplementaryMessageWrapper<ProcessUnstructuredSSResponse> implements ProcessUnstructuredSSResponse {
	 ...
	 * @param mAPDialog
	 */
	public ProcessUnstructuredSSResponseWrapper(MAPDialogSupplementaryWrapper mAPDialog,
			ProcessUnstructuredSSResponse res) {
