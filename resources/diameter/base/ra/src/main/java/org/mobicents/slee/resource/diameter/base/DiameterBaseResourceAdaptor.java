...
public class DiameterBaseResourceAdaptor implements ResourceAdaptor,
  ...
  public void entityActivated() throws ResourceException
  {
    ...
    try
    {
      ...
      ((ISessionFactory)sessionFactory).registerAppFacory( ServerAccSession.class, new AccountingSessionFactory(this) );
      ((ISessionFactory)sessionFactory).registerAppFacory( ClientAccSession.class, new AccountingSessionFactory(this) );
      
      // Register Authorization App Session Factories
      ((ISessionFactory)sessionFactory).registerAppFacory( ServerAuthSession.class, new AuthorizationSessionFactory(this) );
      ((ISessionFactory)sessionFactory).registerAppFacory( ClientAuthSession.class, new AuthorizationSessionFactory(this) );
    }
    catch (Exception e) 
    {
  ...
  /**
   * Method for performing tasks when activity is created, such as
   * informing SLEE about it and storing into internal map.
    ...
    public AppSession getNewSession(String sessionId, Class<? extends AppSession> aClass, ApplicationId applicationId, Object... args)
    {
      try
      {
        if (aClass == ServerAccSession.class)
        {
          ...
          return new ServerAccSessionImpl(stack.getSessionFactory().getNewSession(request.getSessionId()), request, this, 50000, true, new StateChangeListener[]{this});
        }
        else
        {
          if (aClass == ClientAccSession.class)
          {
            return sessionId == null ?
                new ClientAccSessionImpl( stack.getSessionFactory(), this, applicationId ) :
                  new ClientAccSessionImpl( stack.getSessionFactory(),  sessionId, this, applicationId );
          }
        }
  ...
  private class AuthorizationSessionFactory implements IAppSessionFactory, IAuthMessageFactory, ServerAuthSessionListener, StateChangeListener, ClientAuthSessionListener {
    ...
    public AppSession getNewSession(String sessionId, Class<? extends AppSession> aClass, ApplicationId applicationId, Object... args)
    {
      try
      {
        ...
        {
          Request request =(Request) args[0];
          return new ServerAuthSessionImpl(true, this, this, stack.getSessionFactory().getNewSession(request.getSessionId()) );
        }
        else
        {
          return sessionId == null ?
              new ClientAuthSessionImpl( false, this, stack.getSessionFactory(), this) :
                new ClientAuthSessionImpl( false, sessionId, this, stack.getSessionFactory(), this ) ;
        }
      }
      catch (Exception e)
      {
    ...
    public void doAbortSessionAnswerEvent( ServerAuthSession appSession, org.jdiameter.api.auth.events.AbortSessionAnswer asa ) throws InternalException, IllegalDiameterStateException, RouteException, OverloadException
    {
  ...
  private class DiameterProviderImpl implements DiameterProvider {
    ...
    public DiameterActivity createActivity(DiameterIdentityAvp destinationHost,
      ...
      DiameterActivityImpl activity = new DiameterActivityImpl(
          msgFactory, diameterAvpFactory, session, ra, messageTimeout,
    ...
    AccountingServerSessionActivity createAccountingServerActivity(Request req)
        throws CreateActivityException {
      ...
      AccountingServerSessionActivityImpl activity = new AccountingServerSessionActivityImpl(
          msgFactory, diameterAvpFactory, session, ra, messageTimeout, destinationHost, destinationRealm, sleeEndpoint );
      activityCreated(activity);
    ...
    AccountingServerSessionActivity createAccountingServerActivity(
        DiameterIdentityAvp destinationHost,DiameterIdentityAvp destinationRealm)
        throws CreateActivityException {
