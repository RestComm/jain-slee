...
/**
 * Simple implementation of wrapper support. It fetches all data from Alarm notification and encodes it in a way it allows SNMP
 * adaptor to consume it.
 * 
 * @author baranowb
 * 
 */
public class AlarmNotificationWrapperSupport extends NotificationWrapperSupport {
	...
	public void prime(Notification n) {
		...
		if(an.getCause()!=null)
		{
			//TODO: this is stack trace, 1.0 wont support this.
		}
