...
public class AddNotificationHadlerPanel extends Composite implements CommonControl {
  ...
  private void performAdd(int numberOfEntries) {
    ServerConnection.logServiceAsync.addNotificationHandler(loggerName, numberOfEntries, _levelList.getItemText(_levelList.getSelectedIndex()),
        _formaterClassNameBox.getText(), _filterClassNameBox.getText(), new AsyncCallback() {
