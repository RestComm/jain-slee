 ...
 */
public class ActiveAlarmsCard extends Card {

  private BrowseContainer browseContainer = new BrowseContainer();

  public ActiveAlarmsCard() {
    super();
  ...
  public void onShow() {
    ...
    AlarmListPanel alarmListPanel = new AlarmListPanel(browseContainer);
    browseContainer.add("Alarms", alarmListPanel);
  }
}
