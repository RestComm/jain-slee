 ...
 * 
 */
public class ComponentSearchCard extends Card {

  private BrowseContainer browseContainer = new BrowseContainer();

  public ComponentSearchCard() {
    super();
  ...
  public void setData() {
    ComponentSearchPanel componentSearchPanel = new ComponentSearchPanel(browseContainer);
    browseContainer.add("Search", componentSearchPanel);
  }
