 ...
 * 
 */
public class UsageCard extends Card {
  ...
  public void onShow() {
    ...
    ParameterSetListPanel parameterSetsPanel = new ParameterSetListPanel(browseContainer);
    browseContainer.add("Parameter Sets", parameterSetsPanel);
  }
}
