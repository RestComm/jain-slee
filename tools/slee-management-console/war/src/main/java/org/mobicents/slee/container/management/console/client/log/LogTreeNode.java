...
/**
 * This class represents logger or possible logger in some fqdn - org.mobicents (two nodes org and mobicents, both can be logger, or
 * neither) This class displays whather node is logger - allows logger init to default values that loggers take and switching logger of.
 * Also on link click it will display information in BrowseContainer - about logger - level, filter, formatter, handlers...
 * 
 * @author baranowb
 * 
 */
public class LogTreeNode extends Composite {
  ...
  public static final String[] _LEVELS = { _LEVEL_ALL, _LEVEL_SEVERE, _LEVEL_WARNING, _LEVEL_INFO, _LEVEL_CONFIG, _LEVEL_FINE, _LEVEL_FINER, _LEVEL_FINEST,
      _LEVEL_OFF };
