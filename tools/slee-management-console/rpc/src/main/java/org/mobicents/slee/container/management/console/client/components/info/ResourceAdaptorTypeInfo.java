 ...
 * 
 */
public class ResourceAdaptorTypeInfo extends ComponentInfo implements IsSerializable {
  ...
  public ResourceAdaptorTypeInfo(String name, String source, String vendor, String version, String ID, String deployableUnitID, String[] eventTypeIDs, String[] libraryRefs) {
