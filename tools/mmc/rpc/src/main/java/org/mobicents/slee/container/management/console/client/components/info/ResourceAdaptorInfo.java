 ...
 *
 */
public class ResourceAdaptorInfo extends ComponentInfo implements
		IsSerializable {
	
	private String resourceAdaptorTypeID;

	public ResourceAdaptorInfo(String name, String source, String vendor, String version, String ID, String deployableUnitID, String resourceAdaptorTypeID) {
