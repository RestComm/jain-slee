...
public class SbbUsageMBeanUtils {
	...
	public SbbUsageMBeanUtils(MBeanServerConnection mbeanServer,
			ObjectName sbbUsageMBean) {
		super();
	...
	public void close() throws ManagementConsoleException {
		try {
			mbeanServer.invoke(sbbUsageMBean, "close", new Object[] {},
					new String[] {});
		} catch (Exception e) {
			e.printStackTrace();
	...
	public SbbID getSbb() throws ManagementConsoleException {
		try {
			return (SbbID) mbeanServer.invoke(sbbUsageMBean, "getSbb",
	...
	public ServiceID getService() throws ManagementConsoleException {
		try {
			return (ServiceID) mbeanServer.invoke(sbbUsageMBean, "getService",
					new Object[] {}, new String[] {});
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils.doMessage(e));
	...
	public String getUsageParameterSet() throws ManagementConsoleException {
		try {
			return (String) mbeanServer.invoke(sbbUsageMBean,
	...
	public void resetAllUsageParameters() throws ManagementConsoleException {	
		try {
			mbeanServer.invoke(sbbUsageMBean, "resetAllUsageParameters",
					new Object[] {}, new String[] {});
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils.doMessage(e));
	...
	public Long getCounterTypeParameter(String name, boolean reset) throws ManagementConsoleException {
		try {
			return (Long) mbeanServer.invoke(sbbUsageMBean,
	...
	public SampleStatistics getSampleTypeParameter(String name, boolean reset) throws ManagementConsoleException {
		try {
			return (SampleStatistics) mbeanServer.invoke(sbbUsageMBean,
					"get" + name, new Object[] { new Boolean(reset) }, new String[] { "boolean" });
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils.doMessage(e));
	...
	private SBBUsageParameterInfo toSBBUsageParameterInfo(MBeanOperationInfo beanOperationInfo)
			throws ManagementConsoleException {
		ManagementConsoleException exception = new ManagementConsoleException(
				"SBB Usage MBean method " + beanOperationInfo.getName()
		...
		MBeanParameterInfo[] beanParameterInfos = beanOperationInfo
				.getSignature();
		...
		if (returnType.equals(long.class.getName())) {
			...
			CounterTypeSBBUsageParameterInfo parameterInfo = new CounterTypeSBBUsageParameterInfo(
			...
			SampleTypeSBBUsageParameterInfo parameterInfo = new SampleTypeSBBUsageParameterInfo(
					parameterName, parameterValue.getMaximum(), parameterValue
							.getMinimum(), parameterValue.getMean(),
					parameterValue.getSampleCount());
