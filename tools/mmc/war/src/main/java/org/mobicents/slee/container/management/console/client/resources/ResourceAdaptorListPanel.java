...
public class ResourceAdaptorListPanel extends Composite {
	...
	private void setResourceAdaptorList() {
		...
		for (int i = 0; i < resourceAdaptorInfos.length; i++) {
			...
			// COLUMN_ICON
			listPanel.setCell(i, COLUMN_ICON, new Image(
					"images/components.resource adaptor.gif"));

			// COLUMN_NAME
			Hyperlink nameLink = new Hyperlink(resourceAdaptorInfo.getName(),
					resourceAdaptorInfo.getName());
