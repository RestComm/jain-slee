...
public class DefaultOperationsPanel extends Composite implements CommonControl {
	...
	public void onShow() {
		...
		addLogger.addClickListener(new ClickListener() {
			...
			public void onClick(Widget arg0) {
				ServerConnection.logServiceAsync.addLogger(_newLoggerName.getText(), _defaultLoggerLevel.getItemText(_defaultLoggerLevel.getSelectedIndex()), new AsyncCallback() {
