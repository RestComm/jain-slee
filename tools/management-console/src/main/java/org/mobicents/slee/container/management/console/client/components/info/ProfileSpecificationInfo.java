 ...
 *
 */
public class ProfileSpecificationInfo extends ComponentInfo implements
		IsSerializable {
	...
	public ProfileSpecificationInfo(String name, String source, String vendor,
			String version, String ID, String deployableUnitID, String CMPInterfaceName) {
		super(name, source, vendor, version, ID, deployableUnitID);
		this.CMPInterfaceName = CMPInterfaceName;
		componentType = ComponentInfo.PROFILE_SPECIFICATION;
	}
