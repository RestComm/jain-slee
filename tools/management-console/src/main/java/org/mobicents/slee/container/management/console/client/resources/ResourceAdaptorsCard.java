 ...
 * 
 */
public class ResourceAdaptorsCard extends Card {

	private BrowseContainer browseContainer = new BrowseContainer();

	public ResourceAdaptorsCard() {
		super();
	...
	public void onShow() {
		...
		ResourceAdaptorListPanel resourceAdaptorListPanel = new ResourceAdaptorListPanel(browseContainer);
		browseContainer.add("Resource Adaptors", resourceAdaptorListPanel);
	}
}
