...
public class ComponentInfoUtils {
	...
	static public ComponentInfo toComponentInfo(
		...
		if (componentDescriptor instanceof ServiceDescriptor) {
			...
			return new ServiceInfo(
				...
				serviceDescriptor.getSource(),
				serviceDescriptor.getVendor(),
				serviceDescriptor.getVersion(),
				toString(serviceDescriptor.getID()),
				DeployableUnitInfoUtils.toString(serviceDescriptor.getDeployableUnit()),
				serviceDescriptor.getAddressProfileTable(),
				serviceDescriptor.getResourceInfoProfileTable(),
			...
			return new SbbInfo(
					sbbDescriptor.getName(),
					sbbDescriptor.getSource(),
					sbbDescriptor.getVendor(),
					sbbDescriptor.getVersion(),
					toString(sbbDescriptor.getID()),
					DeployableUnitInfoUtils.toString(sbbDescriptor.getDeployableUnit()),
					toString(sbbDescriptor.getAddressProfileSpecification()),
					toStringArray(sbbDescriptor.getEventTypes()),
					toStringArray(sbbDescriptor.getProfileSpecifications()),
					sbbDescriptor.getResourceAdaptorEntityLinks(),
					toStringArray(sbbDescriptor.getResourceAdaptorTypes()),
					toStringArray(sbbDescriptor.getSbbs()));
			...
			return new ResourceAdaptorTypeInfo(
					resourceAdaptorTypeDescriptor.getName(),
					resourceAdaptorTypeDescriptor.getSource(),
					resourceAdaptorTypeDescriptor.getVendor(),
					resourceAdaptorTypeDescriptor.getVersion(),
					toString(resourceAdaptorTypeDescriptor.getID()),
					DeployableUnitInfoUtils.toString(resourceAdaptorTypeDescriptor.getDeployableUnit()),
					toStringArray(resourceAdaptorTypeDescriptor.getEventTypes()));
			...
			return new EventTypeInfo(
					eventTypeDescriptor.getName(),
					eventTypeDescriptor.getSource(),
					eventTypeDescriptor.getVendor(),
					eventTypeDescriptor.getVersion(),
					toString(eventTypeDescriptor.getID()),
					DeployableUnitInfoUtils.toString(eventTypeDescriptor.getDeployableUnit()),
					eventTypeDescriptor.getEventClassName());
			...
			return new ProfileSpecificationInfo(
					profileSpecificationDescriptor.getName(),
					profileSpecificationDescriptor.getSource(),
					profileSpecificationDescriptor.getVendor(),
					profileSpecificationDescriptor.getVersion(),
					toString(profileSpecificationDescriptor.getID()),
					DeployableUnitInfoUtils.toString(profileSpecificationDescriptor.getDeployableUnit()),
					profileSpecificationDescriptor.getCMPInterfaceName());
			...
			return new ResourceAdaptorInfo(
					resourceAdaptorDescriptor.getName(),
					resourceAdaptorDescriptor.getSource(),
					resourceAdaptorDescriptor.getVendor(),
					resourceAdaptorDescriptor.getVersion(),
					toString(resourceAdaptorDescriptor.getID()),
					DeployableUnitInfoUtils.toString(resourceAdaptorDescriptor.getDeployableUnit()),
					toString(resourceAdaptorDescriptor.getResourceAdaptorType()));
		}
		return null;
	}

	static public ComponentInfo[] toComponentInfos(
