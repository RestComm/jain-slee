...
public class SbbEntitiesMBeanUtils
{
   ...
   public SbbEntitiesMBeanUtils(MBeanServerConnection mbeanServer,
         ObjectName sleeManagementMBean) throws ManagementConsoleException {
     this.mbeanServer = mbeanServer;
     try {
        sbbEntitiesMBean = (ObjectName) mbeanServer.getAttribute(
   ...
   {
      try {
         return (Object[]) mbeanServer.invoke(sbbEntitiesMBean,
               "retrieveSbbEntityInfo", new Object[] { sbbeId },
   ...
   throws ManagementConsoleException
   {
      try {
         return (Object[]) mbeanServer.invoke(sbbEntitiesMBean,
               "retrieveAllSbbEntities", new Object[] {},
               new String[] {});
      } catch (Exception e) {
         e.printStackTrace();
         throw new ManagementConsoleException(e);
   ...
   public Object[] removeSbbEntity(String sbbeId)
   throws ManagementConsoleException
   {
      try {
         return (Object[]) mbeanServer.invoke(sbbEntitiesMBean,
               "removeSbbEntity", new Object[] {sbbeId},
               new String[] {String.class.getName()});
      } catch (Exception e) {
         e.printStackTrace();
         throw new ManagementConsoleException(e);
