...
public class SbbInfo extends ComponentInfo implements IsSerializable {
	...
	public SbbInfo(String name, String source, String vendor, String version,
			String ID, String deployableUnitID, String addressProfileSpecificationID, String[] eventTypeIDs, String[] profileSpecificationIDs, String[] resourceAdaptorEntityLinks, String[] resourceAdaptorTypeIDs, String[] sbbIDs) {
