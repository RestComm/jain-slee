...
public class SleePage extends SmartTabPage {
	...
	public static SmartTabPageInfo getInfo() {
		return new SmartTabPageInfo("<image src='images/slee.gif' /> Slee", "Slee management") {
	...
	public void onInit() {
		...
		cardControl.onInit();
		cardControl.add(sleeStateCard, "<image align='absbottom' src='images/sleestate.gif' /> Slee State", true);	
