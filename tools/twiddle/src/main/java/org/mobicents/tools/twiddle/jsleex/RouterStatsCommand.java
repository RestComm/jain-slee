...
public class RouterStatsCommand extends AbstractSleeCommand {
	...
	public void displayHelp() {
		...
		out.println("    -e, --executed-tasks        Returns number of executed tasks. Optionaly it can take positive integer argument.");
		out.println("                                In case argument is present it indicates executor for which value should be returned.");
		...
		out.println("    -i, --idle-time             Returns idle time for particular executor. Requries positive integer argument, which indicates executor.");
		//public long getIdleTime(int executor) throws ManagementException;
		out.println("    -c, --misc-tasks            Returns number of misc tasks(not routing) executed within container. Optionaly it can take positive integer argument.");
		out.println("                                In case argument is present it indicates executor for which value should be returned.");
		...
		out.println("    -t, --executing-time        Returns total time spent in executor. Requries positive integer argument, which indicates executor.");
