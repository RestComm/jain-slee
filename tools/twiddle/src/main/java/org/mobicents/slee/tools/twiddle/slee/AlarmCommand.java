...
public class AlarmCommand extends AbstractSleeCommand {
	...
	public void displayHelp() {
		...
		out.println("    -c, --clear                    Clears alarm which meets criteria from suboptions. \"--id\" or \"--nsrc\" must be present. Following suboptions are supported:");
		out.println("            --id                   Specifies ID of alarm to be cleared. This option MUST NOT be used with any other suboptions.");
		out.println("            --nsrc                 Notification source for which alarms will be cleared. It can be used in conjuction with \"--type\".");
		...
		out.println("                                   Requiers NotificationSource as argument.");
		...
		out.println("                                   Requiers alarm id(s) as argument.");
		out.println("    -a, --active                   Checks if alarm with matching id is active.");
		out.println("                                   Requiers alarm id as argument.");
		out.println();
		out.println("arg:");
