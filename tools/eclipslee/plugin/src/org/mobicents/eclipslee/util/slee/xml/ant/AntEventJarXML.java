 ...
 * @author cath
 */
public class AntEventJarXML extends XML {

	protected AntEventJarXML(Document document, Element root) {
		super(document, root);
	}
	
	public void setXML(String xml) {
		root.setAttribute("eventjarxml", xml);
	}
	
	public String getXML() {
		return root.getAttribute("eventjarxml");
	}
