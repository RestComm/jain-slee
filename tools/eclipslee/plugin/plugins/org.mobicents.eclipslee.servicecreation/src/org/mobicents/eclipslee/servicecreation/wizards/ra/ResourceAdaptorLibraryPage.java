 ...
 */
public class ResourceAdaptorLibraryPage extends WizardPage implements WizardChangeListener {

  private static final String PAGE_DESCRIPTION = "Specify the Resource Adaptor's Libraries.";

  /**
   * @param pageName
   */
  public ResourceAdaptorLibraryPage(String title) {
    super("wizardPage");
    setTitle(title);
