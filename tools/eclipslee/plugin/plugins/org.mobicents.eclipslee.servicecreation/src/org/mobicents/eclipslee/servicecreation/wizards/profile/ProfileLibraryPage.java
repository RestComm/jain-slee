 ...
 */
public class ProfileLibraryPage extends WizardPage implements WizardChangeListener {

  private static final String PAGE_DESCRIPTION = "Specify the Profile Specification's Libraries.";

  /**
   * @param pageName
   */
  public ProfileLibraryPage(String title) {
    super("wizardPage");
    setTitle(title);
