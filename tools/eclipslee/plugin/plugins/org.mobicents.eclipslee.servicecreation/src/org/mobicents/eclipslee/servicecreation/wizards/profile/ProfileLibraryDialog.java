 ...
 */
public class ProfileLibraryDialog extends Dialog {

  private static final String DIALOG_TITLE = "Modify Profile Specification Libraries";

  public ProfileLibraryDialog(Shell parent, LibraryRefXML[] selectedLibraries, String projectName) {	
    super(parent);			
    setBlockOnOpen(true);
