 ...
 */
public class ResourceAdaptorLibraryDialog extends Dialog {

  private static final String DIALOG_TITLE = "Modify Resource Adaptor Libraries";

  public ResourceAdaptorLibraryDialog(Shell parent, LibraryRefXML[] selectedLibraries, String projectName) {	
    super(parent);			
    setBlockOnOpen(true);
