 ...
 */
public class LibraryFinder extends BaseFinder {

  @Override
  protected DTDXML loadJar(JarFile file, JarEntry entry, String jarLocation) throws Exception {
    return new LibraryJarXML(file, entry, jarLocation);
  }

  private static LibraryFinder libraryFinder = new LibraryFinder();

  public static LibraryFinder getDefault() {
    return libraryFinder;
  }

  public DTDXML loadJar(JarFile jar, JarEntry entry) throws Exception {
    return new LibraryJarXML(jar, entry, (String)null);
  }

  public DTDXML loadFile(IFile file) throws Exception {
    return new LibraryJarXML(file);
  }
  ...
  public static LibraryJarXML getLibraryJarXML(IFile file) {
    try {
      LibraryJarXML xml = new LibraryJarXML(file);
      return xml;
    }
    catch (Exception e) {
      return null;
