 ...
 */
public class RaTypeLibraryDialog extends Dialog {

  private static final String DIALOG_TITLE = "Modify Resource Adaptor Type Libraries";

  public RaTypeLibraryDialog(Shell parent, LibraryRefXML[] selectedLibraries, String projectName) {	
    super(parent);			
    setBlockOnOpen(true);
