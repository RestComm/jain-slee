 ...
 */
public class LibraryJarXML extends org.mobicents.eclipslee.util.slee.xml.components.LibraryJarXML {
  ...
  public LibraryJarXML() throws ParserConfigurationException, IOException {
    super(new SLEEEntityResolver(), SLEEEntityResolver.getEmptyXML(PUBLIC_ID, SYSTEM_ID));
    this.osPath = null;
  }

  public LibraryJarXML(IFile file) throws SAXException, IOException, CoreException, ParserConfigurationException {
  ...
  public LibraryJarXML(JarFile jar, JarEntry entry, String location) throws SAXException, IOException, CoreException, ParserConfigurationException {
