 ...
 */
public class SbbLibraryPanel extends Composite implements SelectionListener {
	...
	public SbbLibraryPanel(Composite parent, int style) {
		super(parent, style);
	...
	public void selectProfile(LibraryJarXML xml, LibraryXML profile) {
	...
	public HashMap[] getSelectedLibraries() {
		Object profiles[] = selectedLibraries.getStore().getElements();
