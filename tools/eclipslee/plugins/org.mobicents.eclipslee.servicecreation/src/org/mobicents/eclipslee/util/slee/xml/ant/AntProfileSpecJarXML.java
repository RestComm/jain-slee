 ...
 * @author cath
 */
public class AntProfileSpecJarXML extends XML {

	protected AntProfileSpecJarXML(Document document, Element root) {
		super(document, root);
	}
	
	public void setXML(String xml) {
		root.setAttribute("profilespecjarxml", xml);
	}
	
	public String getXML() {
		return root.getAttribute("profilespecjarxml");
	}
