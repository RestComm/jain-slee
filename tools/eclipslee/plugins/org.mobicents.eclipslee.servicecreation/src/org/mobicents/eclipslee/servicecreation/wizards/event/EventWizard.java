...
//		IFolder mavenModuleFolder = this.getProject().getFolder(this.getMavenModuleName());
//		if(!mavenModuleFolder.exists()) {
//		  mavenModuleFolder.create(true, true, monitor);
//		  MavenProjectUtils.generateEventsModulePomFile(this.getProject(), null, this.getMavenModuleName());
//		}
