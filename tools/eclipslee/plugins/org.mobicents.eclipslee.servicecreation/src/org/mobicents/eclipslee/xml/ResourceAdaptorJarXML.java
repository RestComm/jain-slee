 ...
 */
public class ResourceAdaptorJarXML extends org.mobicents.eclipslee.util.slee.xml.components.ResourceAdaptorJarXML {
	/** Jar location*/
	private String jarLocation = null;
	
	public ResourceAdaptorJarXML() throws ParserConfigurationException, IOException {
		super(new SLEEEntityResolver(), SLEEEntityResolver.getEmptyXML(PUBLIC_ID, SYSTEM_ID));
		this.osPath = null;
	}
	
	public ResourceAdaptorJarXML(JarFile jar, JarEntry entry, String location) throws ParserConfigurationException, SAXException, IOException, CoreException {
	...
	public ResourceAdaptorJarXML(IFile file) throws ParserConfigurationException, SAXException, IOException, CoreException {
