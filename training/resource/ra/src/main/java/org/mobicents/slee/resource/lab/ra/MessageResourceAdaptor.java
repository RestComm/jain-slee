 ...
 * @author amit bhayani
 */
public class MessageResourceAdaptor implements ResourceAdaptor,
		RAFStackListener {
	...
	private transient HashMap<MessageActivityHandle, MessageActivity> activities = null;
	...
	public void activityEnded(ActivityHandle actHandle) {
		...
		this.activities.remove(actHandle);
	}
	...
	public ActivityHandle getActivityHandle(Object obj) {
		...
		for (MessageActivityHandle msgActHndle : this.activities.keySet()) {
	...
	public void queryLiveness(ActivityHandle activityHandle) {
		...
		MessageActivity mssActivity = this.activities.get(activityHandle);
		if (mssActivity == null) {
	...
	public void raActive() {
		...
		try {
			...
			activities = new HashMap<MessageActivityHandle, MessageActivity>();
		} catch (Throwable thr) {
