 ...
 * @author amit bhayani
 */
public abstract class DemoSbb implements Sbb {
    ...
    private SbbContext sbbContext;    // SIP
    ...
    public void onCreateConnectionResponse(CreateConnectionResponse event, ActivityContextInterface aci) {
        ...
        switch (status.getValue()) {
            case ReturnCode.TRANSACTION_EXECUTED_NORMALLY:
                ...
                try {
                    InteractiveVoiceResponse ivr = (InteractiveVoiceResponse) getIvrSbb().create();
                    ActivityContextInterface dialogActivity = this.getDialogActivity(sbbContext.getActivities());
                    if (dialogActivity != null) {
                        dialogActivity.attach(ivr);
                        logger.info("Attaching IVR to dialog activity");
                    }
                    ivr.start(new CallIdentifier(getCallIdentifier()), this.getEndpointName());
                    logger.info("Starting IVR connection");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
    ...
    public ActivityContextInterface getDialogActivity(ActivityContextInterface[] activities) {
    ...
    public void setSbbContext(SbbContext sbbContext) {
        ...
        this.logger = sbbContext.getTracer(DemoSbb.class.getSimpleName());
