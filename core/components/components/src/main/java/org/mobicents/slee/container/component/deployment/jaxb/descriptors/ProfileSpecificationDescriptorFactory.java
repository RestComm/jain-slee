 ...
 */
public class ProfileSpecificationDescriptorFactory extends AbstractDescriptorFactory {

  /**
   * Builds a list of {@link ProfileSpecificationDescriptorImpl} objects, from an {@link InputStream} containing the profile specification jar xml.
   * @param inputStream
   * @return
