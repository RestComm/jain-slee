 ...
 */
public class LibraryDescriptorFactory extends AbstractDescriptorFactory {

  /**
   * Builds a list of {@link LibraryDescriptorImpl} objects, from an {@link InputStream} containing the library jar xml.
   * @param inputStream
   * @return
