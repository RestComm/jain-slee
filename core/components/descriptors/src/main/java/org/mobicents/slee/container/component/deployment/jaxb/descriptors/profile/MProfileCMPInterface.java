...
public class MProfileCMPInterface {
  ...
  public MProfileCMPInterface(org.mobicents.slee.container.component.deployment.jaxb.slee11.profile.ProfileCmpInterface profileCMPInterface11)
  {
    ...
    this.description = profileCMPInterface11.getDescription() == null ? null : profileCMPInterface11.getDescription().getvalue();

    this.profileCmpInterfaceName = profileCMPInterface11.getProfileCmpInterfaceName().getvalue();

    this.cmpFields = new HashMap<String, MCMPField>();

    if(profileCMPInterface11.getCmpField() != null && profileCMPInterface11.getCmpField().size() > 0)
    {
      ...
      {
        this.cmpFields.put(cmpField.getCmpFieldName().getvalue(), new MCMPField(cmpField));
      }
    }
  }
