...
public class MService {
  ...
  public MService(org.mobicents.slee.container.component.deployment.jaxb.slee11.service.Service service11)
  {
    ...
    // Deprecated in 1.1: The Resource Info Profile Table has been deprecated The Resource Adaptor 
    // architecture defined herein describes how resource adaptors may interact with Profile Tables and 
    // Profiles. SBB and/or Service developers should avoid the use of the Resource Info Profile Table as 
    ...
    // this.resourceInfoProfileTable = service11.getResourceInfoProfileTable() == null ? null : service11.getResourceInfoProfileTable().getvalue();
  }
