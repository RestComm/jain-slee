...
/**
 * Tests that the SLEE routes events to SBB event handlers 
 * with signature including custom SBB ACI instead of generic ACI 
 * @author Ivelin Ivanov
 *
 */

public class TestCustomSbbAciHandlerTest implements SleeTCKTest {
    ...
    public TCKTestResult run() throws Exception {
    	...
    	TCKActivityID activityID1 = resource.createActivity("TestCustomAciHandlerInitialActivity");
