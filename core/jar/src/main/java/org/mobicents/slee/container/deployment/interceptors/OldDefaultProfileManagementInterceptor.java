 ...
 *  
 */
public class OldDefaultProfileManagementInterceptor implements
        OldProfileManagementInterceptor {
    ...
    private static Logger logger = Logger
            .getLogger(OldDefaultProfileManagementInterceptor.class);
    ...
    /**
     * This field is populted with context in case when there is no abstract class defined to handle this.
     */
     ...
     *  
     */
    public OldDefaultProfileManagementInterceptor() {
     ...
     * @param isSbbProfile
     */
    public OldDefaultProfileManagementInterceptor(boolean isSbbProfile) {
