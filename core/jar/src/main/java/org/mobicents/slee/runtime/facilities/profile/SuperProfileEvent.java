...
public class SuperProfileEvent {
    ...
    protected ActivityContextInterfaceImpl activityContextInterface;
    
    protected ProfileLocalObjectConcrete profileLocalObjectAfterAction = null;

	public SuperProfileEvent(Address profileAddress, ProfileID profile, Object profileCmpInterfaceConcrete, ProfileTableActivityContextInterfaceFactoryImpl ptableAcif,
			ActivityContextInterfaceImpl activityContextInterface, ProfileLocalObjectConcrete profileLocalObject) {
		super();
		this.profileAddress = profileAddress;
		this.profile = profile;
		this.profileCmpInterfaceConcreteAfterAction = profileCmpInterfaceConcrete;
