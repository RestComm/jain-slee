...
public class ProfileProvisioningMBeanImpl extends ServiceMBeanSupport implements
    ...
    public void createProfileTable(
        ...
        try {
	        ...
	        if(newProfileTableName==null)
	            ...
	            SleeProfileManager profileManager = SleeProfileManager
	                    .getInstance();
	        ...
	        try {
		        ...
		        if(profileSpecification!=null)
		            throw new ProfileTableAlreadyExistsException("Failed creating Profile Table " + 
		            		newProfileTableName + " in " + profileSpecificationID);
            ...
            logger.debug("Profile table does not exist -- creating one  "
	            ...
	            // manager class
	            ProfileSpecificationDescriptorImpl profileSpecificationDescriptor = (ProfileSpecificationDescriptorImpl) sleeContainer
	                    .getComponentDescriptor(profileSpecificationID);
	        ...
	        try {
                ...
                throw new ManagementException(
                        "Profile Specification has not been correctly deployed",e);
	        } catch (Exception e) {
    ...
    public void removeProfileTable(String profileTableName)
        ...
        try {
            ...
            try {
                if (rb) transactionManager.setRollbackOnly();
    ...
    public void renameProfileTable(String oldProfileTableName,
        ...
        profileSpecificationDescriptor = (ProfileSpecificationDescriptorImpl) serviceContainer
                .getComponentDescriptor(profileSpecificationID);
        if(profileSpecificationDescriptor==null)
            throw new UnrecognizedProfileTableNameException();
        /*
         * profileSpecificationDescriptor=new
         * ProfileSpecificationDescriptorImpl();
         * profileSpecificationDescriptor.setCMPInterfaceName(
         * "gov.nist.slee.container.profile.FooProfileCMP");
         * profileSpecificationDescriptor.setManagementAbstractClassName(
         * "gov.nist.slee.container.profile.FooProfileManagementImpl");
         * profileSpecificationDescriptor.setManagementInterfaceName(
         * "gov.nist.slee.container.profile.FooProfileManagement");
         * profileSpecificationDescriptor.setProfileSpecificationID(profileSpecificationID);
         * profileSpecificationDescriptor.setSingleProfile(true); Map
         * indexes=new HashMap(); indexes.put("subscriberName","true");
         * profileSpecificationDescriptor.setProfileIndexes(indexes);
         */
        SleeProfileManager profileManager = SleeProfileManager
                .getInstance();
        ProfileSpecificationID profileSpecification;
    ...
    /**
     * @return ObjectName - The default profile MBean object name if the profile table has been created. Otherwise null.
     * 
    ...
    public ObjectName getDefaultProfile(String profileTableName)
        ...
        try {
            ...
            SleeProfileManager profileManager = SleeProfileManager
                    .getInstance();
            try {
                Object profile = profileManager.findDefaultProfile(profileTableName);
    	        if( profile == null)
    	            throw new UnrecognizedProfileTableNameException();
    	        rb = false;
    ...
    public ObjectName createProfile(String profileTableName,
        ...
        try {
            ...
            // is important so it is replace by a space in the profile name, find a workaround
    ...
    public void removeProfile(String profileTableName, String profileName)
        ...
        try {
	        ...
	        if(profileSpecificationID==null)
	            throw new UnrecognizedProfileTableNameException("Failed removing Profile " + profileName + 
	        ...
	        if(profileMBeanName==null)
	            throw new UnrecognizedProfileNameException("Failed removing Profile " + profileName + 
	            		" from Profile Table " + profileTableName);
	        ...
	        logger.debug("Profile " + profileName + " removed from profile table "
	                + profileTableName);
    ...
    public Collection getProfileTables() throws ManagementException {
        ...
        // a serializable copy is needed. the original reference has ties to the distributed cache
