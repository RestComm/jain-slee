...
public class ServiceUsageMBeanImpl extends StandardMBean implements
    ...
    public String[] getUsageParameterSets(SbbID sbbId)
        ...
        try {
            ...
            if ( usageParameterSets == null ) throw new InvalidArgumentException ("No usage parameters found ");
    ...
    public ObjectName getSbbUsageMBean(SbbID sbbId)
        ...
        try {
           ...
           checkSbbUsageParams(sbbId);
           ObjectName on = (ObjectName) service.getUsageParameterObjectName(sbbId);
           if ( on == null ) 
    ...
    public ObjectName getSbbUsageMBean(SbbID sbbId, String name)
        ...
        try {
           ...
           checkSbbUsageParams(sbbId);
           ObjectName on = (ObjectName) service.getUsageParameterObjectName(sbbId,name);
          ...
          return on;
            ...
            logger.error("unexpected exception getting usage mbean name = " + name 
                    + " sbbid = " + sbbId, ex);
    ...
    public void resetAllUsageParameters(SbbID sbbId)
        ...
        try {
            ...
            if ( usageParam != null ) usageParam.reset();
    ...
    public void resetAllUsageParameters() throws ManagementException {
        ...
        try {
            ...
            for (Iterator it = Service.getAllUsageParameters(this.serviceID); it.hasNext();) {
    ...
    private void checkSbbUsageParams(SbbID sbbId)
            ...
            UnrecognizedSbbException , SystemException, UnrecognizedServiceException {
        ...
        if ( !this.service.isComponent(sbbId))
            throw new UnrecognizedSbbException ("This sbb is not part of this service serviceID = " +
