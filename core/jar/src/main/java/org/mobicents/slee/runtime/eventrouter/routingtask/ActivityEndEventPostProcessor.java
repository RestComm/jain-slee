		...
		do {
			...
			try {
				...
				if (rootSbbEntity != null) {
					invokeSbbRolledBack = handleRollback.handleRollback(null,null,null,caught,rootSbbEntity.getSbbDescriptor().getClassLoader(),txMgr);
				}
				...
				try {
					...
					if (invokeSbbRolledBack) {
						try {
							if (rootSbbEntity != null) {
								handleSbbRollback.handleSbbRolledBack(rootSbbEntity, null, null, null, rootSbbEntity.getSbbDescriptor().getClassLoader(), true, txMgr);
							}
						} catch (Exception ex) {
