...
public class DeployableUnit {
	 ...
	 * @throws Exception 
	 */
	public DeployableUnit(DeploymentInfo duDeploymentInfo,
		...
		installActions.add(new Object[] { "install",
				duDeploymentInfo.url.toString() });
	...
	public boolean hasDependenciesSatisfied(boolean showMissing) {
		...
		externalDependencies.removeAll(deploymentManager
