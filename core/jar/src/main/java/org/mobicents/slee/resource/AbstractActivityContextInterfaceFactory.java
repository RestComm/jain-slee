...
public class AbstractActivityContextInterfaceFactory implements Serializable {
	...
	protected AbstractActivityContextInterfaceFactory(SleeContainer sleeContainer,
	 ...
	 */
	protected ActivityContextInterface getACI(Object activity) throws NullPointerException,
	UnrecognizedActivityException, FactoryException {
		if (activity == null) {
			throw new NullPointerException("null activity object");
		}
		ActivityHandle handle = null;
		for (ResourceAdaptorEntity raEntity : sleeContainer.getResourceManagement().getResourceAdaptorEntitiesPerType().get(resourceAdaptorTypeID)) {
	...
	public boolean equals(Object obj) {
		if (obj != null && obj.getClass() == this.getClass()) {
			return ((AbstractActivityContextInterfaceFactory)obj).resourceAdaptorTypeID.equals(this.resourceAdaptorTypeID);
		}
		else {
			return false;
		}
