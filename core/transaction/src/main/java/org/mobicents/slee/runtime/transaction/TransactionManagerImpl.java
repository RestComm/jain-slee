...
public class TransactionManagerImpl extends ServiceMBeanSupport implements
	 ...
	 */
	private Map sleeTransactions = new ConcurrentHashMap();

	/**
	 * A map of objects that are intended to be used at the time when an ongoing
	 * transaction completes
	 */
	private Map txDeferredTable = new ConcurrentHashMap();
	...
	public void stopService() throws Exception {
		...
		JndiRegistrationManager.unregisterWithJndi(JNDI_NAME);
	}
