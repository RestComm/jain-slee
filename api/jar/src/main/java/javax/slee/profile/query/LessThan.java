...
public final class LessThan extends OrderedQueryExpression {
    /**
     * Create a <code>LessThan</code> query expression.  A profile will match the
     * expression criteria if the value of the <code>attrName</code> attribute
     * is less than <code>attrValue</code>, as determined by {@link Comparable#compareTo(Object)}.
     ...
     */
    public LessThan(String attrName, Object attrValue) throws NullPointerException {
     ...
     * Create a <code>LessThan</code> query expression.  A profile will match the
     * expression criteria if the value of the <code>attrName</code> attribute
     * is less than <code>attrValue</code>, as determined by {@link java.text.Collator#compare(String, String)},
     ...
     */
    public LessThan(String attrName, String attrValue, QueryCollator collator) throws NullPointerException {
