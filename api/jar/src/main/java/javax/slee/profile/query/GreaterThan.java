...
/**
 * The <code>GreaterThan</code> class represents a dynamic query expression that
...
public final class GreaterThan extends OrderedQueryExpression {
    /**
     * Create a <code>GreaterThan</code> query expression.  A profile will match
     * the expression criteria if the value of the <code>attrName</code> attribute
     * is greater than <code>attrValue</code>, as determined by {@link Comparable#compareTo(Object)}
    ...
    /**
     * Create a <code>GreaterThan</code> query expression.  A profile will match the
     * expression criteria if the value of the <code>attrName</code> attribute
     * is greater than <code>attrValue</code>, as determined by {@link java.text.Collator#compare(String, String)},
     ...
     */
    public GreaterThan(String attrName, String attrValue, QueryCollator collator) throws NullPointerException {
