...
/**
 * Impl of {@link EventRouterExecutorStatistics}. This class is not thread safe due to performance overhead introduced
 * when collecting stats, i.e., errors in values due to multiple threads accessing the statistics state are not
 * important.
 *
 * @author martins
 */
public class EventRouterExecutorStatisticsImpl implements EventRouterExecutorStatistics {
    ...
    private final AtomicInteger activitiesMapped = new AtomicInteger(0);
     ...
     * @param routingTime the time spent to route the event, in milliseconds
     */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mobicents.slee.runtime.eventrouter.stats.EventRouterExecutorStatistics
	 * #addEventTypeRoutingStatistics(javax.slee.EventTypeID)
     */
    public void addEventTypeRoutingStatistics(EventTypeID eventTypeID) {
        eventTypeRoutingStatisticsMap.put(eventTypeID, new EventTypeRoutingStatisticsImpl(eventTypeID));
    }
    ...
    public long getAverageEventRoutingTime(EventTypeID eventTypeID) {
        ...
        return eventTypeRoutingStatistics == null ? 0L : eventTypeRoutingStatistics.getAverageEventRoutingTime();
    }
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mobicents.slee.runtime.eventrouter.stats.EventRouterExecutorStatistics#getEventsRouted(javax.slee.EventTypeID)
     */
    public long getEventsRouted(EventTypeID eventTypeID) {
        final EventTypeRoutingStatistics eventTypeRoutingStatistics = getEventTypeRoutingStatistics(eventTypeID);
        return eventTypeRoutingStatistics == null ? 0L : eventTypeRoutingStatistics.getEventsRouted();
    }

    /*
	 * (non-Javadoc)
	 * 
	 * @see org.mobicents.slee.runtime.eventrouter.stats.EventRouterExecutorStatistics#getExecutedTasks()
     */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mobicents.slee.runtime.eventrouter.stats.EventRouterExecutorStatistics#getExecutingTime()
     */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mobicents.slee.runtime.eventrouter.stats.EventRouterExecutorStatistics#getIdleTime()
     */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mobicents.slee.runtime.eventrouter.stats.EventRouterExecutorStatistics#getMiscTasksExecuted()
     */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mobicents.slee.runtime.eventrouter.stats.EventRouterExecutorStatistics#getMiscTasksExecutingTime()
     */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mobicents.slee.runtime.eventrouter.stats.EventRouterExecutorStatistics#getRoutingTime(javax.slee.EventTypeID)
     */
    public long getRoutingTime(EventTypeID eventTypeID) {
        final EventTypeRoutingStatistics eventTypeRoutingStatistics = getEventTypeRoutingStatistics(eventTypeID);
        return eventTypeRoutingStatistics == null ? 0L : eventTypeRoutingStatistics.getRoutingTime();
    }

    /**
     * Adds the time for a misc task execution.
     *
     * @param executionTime the time spent to execute the misc task
     */
