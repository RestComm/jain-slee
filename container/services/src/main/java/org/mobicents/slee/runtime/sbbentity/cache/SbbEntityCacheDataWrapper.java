...
public class SbbEntityCacheDataWrapper {
	...
	public SbbEntityCacheDataWrapper(SbbEntityID sbbEntityID, MobicentsCluster cluster,
			SleeTransactionManager transactionManager) {

		this.transactionManager = transactionManager;
		this.attachedActivityContextsCacheData = new AttachedActivityContextsCacheData(sbbEntityID,
	...
	public void setCmpField(String cmpField, Object cmpValue) {
		...
		if (cmpField != null) {
			...
			SbbEntityCmpFieldCacheKey subKey = new SbbEntityCmpFieldCacheKey(rootKey.getSbbEntityID(),
					rootKey.getType(), cmpField);
	...
	public Object getCmpField(String cmpField) {
		SbbEntityCacheKey rootKey = cmpFieldsCacheData.getKey();
		SbbEntityCmpFieldCacheKey subKey = new SbbEntityCmpFieldCacheKey(rootKey.getSbbEntityID(), rootKey.getType(),
				cmpField);
