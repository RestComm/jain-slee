...
public class SleeContainerService implements Service<SleeContainer> {
	...
	public void start(StartContext context) throws StartException {
		...
		TransactionManager cacheTransactionManager = cache.getJBossCache().getAdvancedCache().getTransactionManager();
		log.debug("cacheTransactionManager: "+cacheTransactionManager);

		Configuration config = cache.getJBossCache().getCacheConfiguration();
