...
public class SleeMbeanDefinition extends SimpleResourceDefinition {
    ...
    public static final SleeMbeanDefinition INSTANCE = new SleeMbeanDefinition();

    protected static final SimpleAttributeDefinition[] MBEAN_ATTRIBUTES = {
            //NAME, // name is read-only
    };

    private SleeMbeanDefinition() {
        super(MBEAN_PATH,
                SleeExtension.getResourceDescriptionResolver(MBEAN),
                SleeMbeanAdd.INSTANCE,
                SleeMbeanRemove.INSTANCE);
    }

    @Override
    public void registerChildren(ManagementResourceRegistration resourceRegistration) {
        super.registerChildren(resourceRegistration);
        resourceRegistration.registerSubModel(SleeMbeanPropertyDefinition.INSTANCE);
    }
