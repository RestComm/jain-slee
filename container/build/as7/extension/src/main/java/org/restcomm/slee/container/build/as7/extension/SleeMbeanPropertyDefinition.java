...
public class SleeMbeanPropertyDefinition extends SimpleResourceDefinition {
    ...
    public static final SleeMbeanPropertyDefinition INSTANCE = new SleeMbeanPropertyDefinition();
    ...
    private SleeMbeanPropertyDefinition() {
        super(PROPERTY_PATH,
                SleeExtension.getResourceDescriptionResolver(SleeMbeanDefinition.MBEAN + "." + PROPERTY),
                SleeMbeanPropertyAdd.INSTANCE,
                SleeMbeanPropertyRemove.INSTANCE);
    }
